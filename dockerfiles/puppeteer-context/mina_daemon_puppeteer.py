...
def start_daemon():
  ...
  # log_plain('{"puppeteer_script_event": true, "puppeteer_event_type": "node_initialized"')
...
def stop_daemon():
  ...
  log_plain('{"puppeteer_script_event": true, "puppeteer_event_type": "node_offline", "message":"daemon is being stopped by puppeteer script and is going offline"}')
