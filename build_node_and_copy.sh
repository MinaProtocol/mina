...
#rm -r ../snarkyjs/src/node_bindings/snippets
#cp -r _build/default/src/lib/crypto/kimchi_bindings/js/node_js/snippets ../snarkyjs/src/node_bindings/snippets
...
sed -i 's/return \[0,Exn,t\]/return joo_global_object.Error(t.c)/' ../snarkyjs/src/node_bindings/snarky_js_node.bc.js
