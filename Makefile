...
test-withsnark:
	source scripts/test_all.sh ; cd src; CODA_CONSENSUS_MECHANISM=proof_of_signature WITH_SNARKS=true DUNE_PROFILE=$(DUNE_PROFILE) run_integration_test full-test
