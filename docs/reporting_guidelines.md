...
If you believe someone is violating the code of conduct we ask that you report it to O(1) Labs by emailing conduct@o1labs.org.
...
You will receive an email from O(1) Labs' Code of Conduct response team acknowledging receipt as soon as possible, but within 24 hours.
...
* A permanent or temporary ban from some or all O(1) Labs spaces (events, meetings, mailing lists, Discord, etc.)
...
Finally, the response team will make a report on the situation to the O(1) Labs board. The board may choose to issue a public report of the incident or take additional actions.

## Appealing the response

Only permanent resolutions (such as bans) may be appealed. To appeal a decision of the working group, contact the O(1) Labs board at board@o1labs.org with your appeal and they will review your case.
