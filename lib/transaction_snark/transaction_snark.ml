...
module Statement = struct
  module T = struct
    type t =
      { source: Nanobit_base.Frozen_ledger_hash.Stable.V1.t
      ; target: Nanobit_base.Frozen_ledger_hash.Stable.V1.t
  ...
  let gen =
    ...
    let%map source = Nanobit_base.Frozen_ledger_hash.gen
    and target = Nanobit_base.Frozen_ledger_hash.gen
