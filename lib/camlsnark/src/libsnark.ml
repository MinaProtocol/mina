...
module Make (M : sig val prefix : string end) = struct
  ...
  let init =
    foreign (with_prefix M.prefix "init_public_params")
      (void @-> returning void)
  ;;
  ...
  module Field : sig
    ...
    module T = struct
      ...
      let size_in_bits =
        let stub =
          foreign (func_name "size_in_bits")
            (void @-> returning int)
        in
        stub ()
      ;;
      ...
      let schedule_delete t =
        Caml.Gc.finalise delete t
      ;;

      let print =
        foreign (func_name "print")
          (typ @-> returning void)
      ;;

      let random =
        let stub =
          foreign (func_name "random")
            (void @-> returning typ)
        in
        fun () ->
          let x = stub () in
      ...
      let is_square =
        foreign (func_name "is_square")
          (typ @-> returning bool)

      let sqrt =
        let stub =
          foreign (func_name "sqrt")
            (typ @-> returning typ)
        in
        fun x ->
          let y = stub x in
      ...
      let add =
        let stub =
          foreign (func_name "add")
            (typ @-> typ @-> returning typ)
        in
        fun x y ->
          let z = stub x y in
          schedule_delete z;
      ...
      let equal =
        foreign (func_name "equal")
          (typ @-> typ @-> returning bool)
      ;;
    ...
    module Vector = struct
      ...
      let get =
        let stub =
          foreign (func_name "get")
            (typ @-> int @-> returning T.typ)
        in
        fun t i ->
          let x = stub t i in
      ...
      let length =
        foreign (func_name "length")
          (typ @-> returning int)
      ;;

      let emplace_back =
        foreign (func_name "emplace_back")
          (typ @-> T.typ @-> returning void)
      ;;
    end
  ...
  module Var : sig
    ...
    let index =
      let stub =
        foreign (func_name "index")
          (typ @-> returning size_t)
      in
      fun v ->
        let r = stub v in
  ...
  module Linear_combination : sig
    ...
    module Term = struct
      ...
      let func_name = with_prefix prefix
      let delete =
        foreign (func_name "delete") (typ @-> returning void)

      let create =
        let stub =
          foreign (func_name "create")
            (Field.typ @-> Var.typ @-> returning typ)
        in
        fun x v ->
          let t = stub x v in
          Caml.Gc.finalise delete t;
    ...
    let of_var : Var.t -> t =
      let stub =
        foreign (func_name "of_var")
          (Var.typ @-> returning typ)
      in
      fun v ->
        let t = stub v in
        schedule_delete t;
  ...
  module R1CS_constraint : sig
    ...
    let create =
      foreign (with_prefix M.prefix "r1cs_constraint_create")
        (Linear_combination.typ
          @-> Linear_combination.typ
          @-> Linear_combination.typ
          @-> returning typ)
    ;;
  ...
  module Keypair : sig
    ...
    let pk =
      let stub =
        foreign (func_name "pk")
          (typ @-> returning Proving_key0.typ)
      in
      fun t ->
        let k = stub t in
        Caml.Gc.finalise Proving_key0.delete k;
        k

    let vk =
      let stub =
        foreign (func_name "vk")
          (typ @-> returning Verification_key.typ)
      in
      fun t ->
        let k = stub t in
  ...
  module R1CS_constraint_system : sig
    ...
    let report_statistics =
      foreign (func_name "report_statistics")
        (typ @-> returning void)
    ;;

    let check_exn =
      let stub =
        foreign (func_name "check")
          (typ @-> returning bool)
      in
      fun sys ->
    ...
    let create_keypair =
      let stub =
        foreign (func_name "create_keypair")
          (typ @-> returning Keypair.typ)
      in
      fun t ->
  ...
  module Protoboard : sig
    ...
    val renumber_and_append_constraints
      : t -> R1CS_constraint_system.t -> Linear_combination.Vector.t -> int -> unit
    ...
    module Variable : sig
      ...
      let typ = ptr void
      let delete =
        foreign (with_prefix M.prefix "protoboard_variable_delete")
          (typ @-> returning void)

      let index =
        foreign (with_prefix M.prefix "protoboard_variable_index")
          (typ @-> returning int)
    end
    ...
    module Variable_array = struct
      ...
      let delete =
        foreign (with_prefix prefix "delete")
          (typ @-> returning void)

      let create =
        let stub =
          foreign (with_prefix prefix "create")
            (void @-> returning typ)
        in
        fun () ->
          let t = stub () in
      ...
      let emplace_back =
        foreign (with_prefix prefix "emplace_back")
    ...
    let renumber_and_append_constraints =
      foreign (func_name "renumber_and_append_constraints")
        (typ
         @-> R1CS_constraint_system.typ
         @-> Linear_combination.Vector.typ
         @-> int
         @-> returning void)
    ;;
    ...
    let augment_variable_annotation =
      foreign (func_name "augment_variable_annotation")
    ...
    let num_variables =
      foreign (func_name "num_variables")
        (typ @-> returning int)
    ;;

    let set_input_sizes =
      foreign (func_name "set_input_sizes")
        (typ @-> int @-> returning void)
    ;;
    ...
    let allocate_variable =
      let stub =
        foreign (func_name "allocate_variable")
    ...
    let allocate_variable_array =
      let stub =
        foreign (func_name "allocate_variable_array")
    ...
    let auxiliary_input =
      let stub =
        foreign (func_name "auxiliary_input")
  ...
  module Proving_key = struct
    ...
    let r1cs_constraint_system =
      foreign (with_prefix M.prefix "proving_key_r1cs_constraint_system")
  ...
  module Proof : sig
    ...
    let create_ =
      let stub =
        foreign (func_name "create")
          (Proving_key.typ @-> Field.Vector.typ @-> Field.Vector.typ @-> returning typ)
      in
    ...
    let create key ~primary ~auxiliary =
  ...
  module Bigint : sig
    ...
    module Common (N : sig val prefix : string end) = struct
      type t = unit ptr
      let typ = ptr void

      let func_name = with_prefix (with_prefix (with_prefix M.prefix "bigint") N.prefix)
      ...
      let test_bit =
        foreign (func_name "test_bit")
          (typ @-> int @-> returning bool)
      ;;
    ...
    module R = struct
      let prefix = "r"
      include Common(struct let prefix = prefix end)
      let func_name = with_prefix (with_prefix (with_prefix M.prefix "bigint") prefix)

      let div =
        let stub =
          foreign (func_name "div")
            (typ @-> typ @-> returning typ)
        in
        fun x y ->
          let z = stub x y in
          Caml.Gc.finalise delete z;
          z
      ;;
      ...
      let of_numeral =
        ...
        fun s ~base ->
          ...
          Caml.Gc.finalise delete n;
          n
      ;;

      let of_decimal_string =
        let stub =
          foreign (func_name "of_decimal_string")
            (string @-> returning typ)
        in
        fun s ->
          let n = stub s in
          Caml.Gc.finalise delete n;
      ...
      let compare =
        foreign (func_name "compare")
          (typ @-> typ @-> returning int)
      ...
      let to_field =
        let stub =
          foreign (func_name "to_field")
            (typ @-> returning Field.typ)
        in
        fun n ->
          let x = stub n in
          Caml.Gc.finalise Field.delete x;
    ...
    module Q = Common(struct let prefix = "q" end)
  end

  let field_size =
    let stub =
      foreign (with_prefix M.prefix "field_size")
...
module Bn128 = Make(struct let prefix = "camlsnark_bn128" end)
module type S = module type of Bn128
module Mnt6 = Make(struct let prefix = "camlsnark_mnt6" end)
module Mnt4 = Make(struct let prefix = "camlsnark_mnt4" end)
...
module Curves = struct
  ...
  module Mnt4_ = struct
    module G1 = struct
      let generator =
        mk_generator Mnt6.Field.typ Mnt6.Field.delete "mnt4_G1"
  ...
  module Mnt6 = struct
    module G1 = struct
      let generator =
        mk_generator Mnt4.Field.typ Mnt4.Field.delete "mnt6_G1"
