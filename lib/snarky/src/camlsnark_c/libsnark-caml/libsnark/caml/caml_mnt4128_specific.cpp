...
camlsnark_mnt4128_r1cs_se_ppzksnark_verifier_gadget_create(
    protoboard<FieldT>* pb,
...
void camlsnark_mnt4128_r1cs_se_ppzksnark_verifier_gadget_delete(
    r1cs_se_ppzksnark_verifier_gadget<ppT>* g) {
  delete g;
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_verifier_gadget_generate_r1cs_constraints(
    r1cs_se_ppzksnark_verifier_gadget<ppT>* g) {
  g->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_verifier_gadget_generate_r1cs_witness(
    r1cs_se_ppzksnark_verifier_gadget<ppT>* g) {
  g->generate_r1cs_witness();
}
...
camlsnark_mnt4128_r1cs_se_ppzksnark_online_verifier_gadget_create(
    protoboard<FieldT>* pb,
    r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable<ppT>* vk,
    pb_variable_array<FieldT>* input,
    int elt_size,
...
void camlsnark_mnt4128_r1cs_se_ppzksnark_online_verifier_gadget_delete(
    r1cs_se_ppzksnark_online_verifier_gadget<ppT>* g) {
  delete g;
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_online_verifier_gadget_generate_r1cs_constraints(
    r1cs_se_ppzksnark_online_verifier_gadget<ppT>* g) {
  g->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_online_verifier_gadget_generate_r1cs_witness(
    r1cs_se_ppzksnark_online_verifier_gadget<ppT>* g) {
  g->generate_r1cs_witness();
}
...
bool camlsnark_mnt4128_g1_delete(libff::G1<ppT>* a) {
  delete a;
}
