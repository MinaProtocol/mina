...
public:
  ...
  void generate_r1cs_equals_constraints(const Fp6_variable<Fp6T> &other);
  void generate_r1cs_equals_unitary_inverse_constraints(const Fp6_variable<Fp6T> &other);
