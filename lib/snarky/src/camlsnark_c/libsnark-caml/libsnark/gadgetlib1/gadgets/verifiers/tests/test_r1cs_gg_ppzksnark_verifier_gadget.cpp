...
void test_verifier(const std::string &annotation_A, const std::string &annotation_B)
{
    ...
    const r1cs_gg_ppzksnark_keypair<ppT_A> keypair = r1cs_gg_ppzksnark_generator<ppT_A>(example.constraint_system);
    const r1cs_gg_ppzksnark_proof<ppT_A> pi = r1cs_gg_ppzksnark_prover<ppT_A>(keypair.pk, example.primary_input, example.auxiliary_input);
...
int main(void)
{
    ...
    test_exponentiation_gadget<libff::mnt4_Fq4, Fp4_variable, Fp4_mul_gadget, Fp4_sqr_gadget, libff::mnt4_q_limbs>(libff::mnt4_swparams::final_exponent_last_chunk_abs_of_w0, "mnt4_Fq4");
    ...
    test_exponentiation_gadget<libff::mnt6_Fq6, Fp6_variable, Fp6_mul_gadget, Fp6_sqr_gadget, libff::mnt6_q_limbs>(libff::mnt6_swparams::final_exponent_last_chunk_abs_of_w0, "mnt6_Fq6");
