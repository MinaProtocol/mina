...
let state_tooltip = 
  [ `Text "The zk-SNARK proof serves as a succinct blockchain,
  ...
  ; `Text " of two versions of the database of accounts.
...
let account_tooltip = 
  [
    `Text "Once a client has a protocol state and a succinct blockchain certifying that state, \
  ...
  ; `New_line
  ; `Text "The succinct blockchain, protocol state, merkle-path, and account information are altogether just a few kilobytes,
