...
function usage() {
  ...
  echo "  SIGN                        The Sign the debian flag. If defined, script will handle signed debian package"
  echo ""
  exit 1
}
