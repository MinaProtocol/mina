...
docker run --network replayer --volume $BUILDKITE_BUILD_CHECKOUT_PATH:/workdir gcr.io/o1labs-192920/mina-rosetta:$MINA_DOCKER_TAG mina-indexer-test --archive_uri $PG_CONN
