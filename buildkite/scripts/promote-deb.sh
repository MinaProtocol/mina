...
function usage() {
  ...
  echo ""
  echo "Example: $0 --package mina-archive --version 2.0.0devnet-rc1-devnet-48efea4 --architecture amd64 --codename bullseye --from-component unstable --to-component nightly"
  exit 1
}
