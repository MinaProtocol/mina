...
git show --oneline origin/${BUILDKITE_PULL_REQUEST_BASE_BRANCH} || true
git fetch -v -- origin ${BUILDKITE_PULL_REQUEST_BASE_BRANCH}:refs/remotes/origin/${BUILDKITE_PULL_REQUEST_BASE_BRANCH}
git show --oneline origin/${BUILDKITE_PULL_REQUEST_BASE_BRANCH}

echo "--- Fetch the latest $1"
git show --oneline origin/$1 || true
git fetch -v -- origin $1:refs/remotes/origin/$1
git show --oneline origin/$1
