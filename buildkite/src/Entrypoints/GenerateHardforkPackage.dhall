                ...
                , Command.build
                    ...
                    , commands =
                        ...
                        # [ Cmd.run
                          ...
                          , Cmd.runInDocker
                              Cmd.Docker::{ image = image }
                              "curl -sL ${spec.config_json_gz_url} | gunzip > config.json && FORKING_FROM_CONFIG_JSON=config.json /workdir/scripts/hardfork/mina-verify-packaged-fork-config --network ${Network.lowerName
