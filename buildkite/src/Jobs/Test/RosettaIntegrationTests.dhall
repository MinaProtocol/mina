      ...
      Command.build
        Command.Config::{
          commands = [
            ...
            Cmd.runInDocker Cmd.Docker::{image="gcr.io/o1labs-192920/mina-rosetta:\\\${MINA_DOCKER_TAG}", entrypoint=" --entrypoint 'buildkite/scripts/rosetta-integration-tests_quick.sh 1'"} "bash"
          ],
