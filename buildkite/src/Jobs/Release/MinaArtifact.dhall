  ...
  Pipeline.Config::{
    ...
    steps = [
      ...
      let puppeteeredSpec = DockerImage.ReleaseSpec::{
        ...
        extra_args="--build-arg mina_deb_version=\\\${MINA_DEB_VERSION} --build-arg CODA_VERSION=\\\${CODA_VERSION} --build-arg MINA_BRANCH=\\\${MINA_GIT_BRANCH} --build-arg deb_repo=\\\${MINA_DEB_REPO}",
