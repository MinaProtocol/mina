...
let Network
    : Type
    = < Devnet | Mainnet | MesaMut >

let capitalName =
          \(network : Network)
      ->  merge
            { Devnet = "Devnet", Mainnet = "Mainnet", MesaMut = "MesaMut" }
            network

let lowerName =
          \(network : Network)
      ->  merge
            { Devnet = "devnet", Mainnet = "mainnet", MesaMut = "mesa-mut" }
            network
...
let requiresMainnetBuild =
          \(network : Network)
      ->  merge { Devnet = False, Mainnet = True, MesaMut = False } network
