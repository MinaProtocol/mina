...
let Artifact : Type  = < Daemon | Archive | ArchiveMigration | CreateLegacyGenesis | TestExecutive | BatchTxn | Rosetta | ZkappTestTransaction | FunctionalTestSuite >
...
let toDebianName = \(artifact : Artifact) ->
  merge {
    ...
    , Archive = "archive"
    , ArchiveMigration  = "archive_migration"
    , CreateLegacyGenesis = "create-legacy-genesis"
    , TestExecutive = "test_executive"
    , BatchTxn = "batch_txn"
    , Rosetta = "" 
    , ZkappTestTransaction = "zkapp_test_transaction"
