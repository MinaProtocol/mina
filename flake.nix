{
  ...
  inputs.utils.url = "github:MinaProtocol/flake-utils-plus";
  inputs.nixpkgs.url = "github:nixos/nixpkgs/nixos-unstable-small";

  inputs.mix-to-nix.url = "github:MinaProtocol/mix-to-nix";
  inputs.nix-npm-buildPackage.url = "github:MinaProtocol/nix-npm-buildpackage";
  inputs.nix-npm-buildPackage.inputs.nixpkgs.follows = "nixpkgs";
  inputs.opam-nix.url = "github:MinaProtocol/opam-nix";
  ...
  # For nix/compat.nix
  inputs.flake-compat.url = "github:MinaProtocol/flake-compat";
  inputs.flake-compat.flake = false;
  inputs.gitignore-nix.url = "github:MinaProtocol/gitignore.nix";
  inputs.gitignore-nix.inputs.nixpkgs.follows = "nixpkgs";

  inputs.nix-filter.url = "github:MinaProtocol/nix-filter";

  inputs.flake-buildkite-pipeline.url = "github:MinaProtocol/flake-buildkite-pipeline";

  inputs.nix-utils.url = "github:MinaProtocol/nix-utils";

  inputs.flockenzeit.url = "github:MinaProtocol/Flockenzeit";
