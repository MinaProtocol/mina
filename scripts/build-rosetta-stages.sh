...
time cat dockerfiles/Dockerfile-rosetta | docker build \
  --target builder \
  -t gcr.io/o1labs-192920/mina-rosetta-builder:dev-$TAG \
  --cache-from gcr.io/o1labs-192920/mina-rosetta-opam-deps:$TAG \
  --build-arg "DUNE_PROFILE=dev" \
  --build-arg "MINA_BRANCH=${GITBRANCH}" -
docker push gcr.io/o1labs-192920/mina-rosetta-builder:dev-$TAG
time cat dockerfiles/Dockerfile-rosetta | docker build \
  --target production \
  -t gcr.io/o1labs-192920/mina-rosetta:dev-$TAG \
  --cache-from gcr.io/o1labs-192920/mina-rosetta-builder:dev-$TAG \
  --build-arg "DUNE_PROFILE=dev" \
  --build-arg "MINA_BRANCH=${GITBRANCH}" -
docker push gcr.io/o1labs-192920/mina-rosetta:dev-$TAG
...
time cat dockerfiles/Dockerfile-rosetta | docker build \
  --target production \
  -t gcr.io/o1labs-192920/mina-rosetta:medium-curves-$TAG \
  --cache-from gcr.io/o1labs-192920/mina-rosetta-builder:medium-curves-$TAG \
  --build-arg "MINA_BRANCH=${GITBRANCH}" -
docker push gcr.io/o1labs-192920/mina-rosetta:medium-curves-$TAG
