...
DEBIAN_SKIP_LEDGERS_COPY=y RUNTIME_CONFIG_JSON=$PWD/localnet/fork_config.json LEDGER_TARBALLS="$(echo $PWD/localnet/prefork_hf_ledgers/*.tar.gz)" ./scripts/debian/build.sh "daemon_devnet_hardfork"
