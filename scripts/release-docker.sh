...
VALID_SERVICES=('mina-archive', 'mina-daemon' 'mina-rosetta' 'mina-toolchain' 'bot' 'leaderboard' 'delegation-backend' 'delegation-backend-toolchain' 'mina-test-executive' 'mina-batch-txn' 'mina-zkapp-test-transaction' 'delegation-verify' )
