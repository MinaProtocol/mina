...
#
# This is a dirty duplication of the rebuild-deb.sh script.
...
PROJECT="coda-$(echo "$DUNE_PROFILE" | tr _ -)-deb10"
...
Priority: optional
Architecture: amd64
Depends: libffi6, libgmp10, libgomp1, libjemalloc2, libprocps7, libssl1.1, miniupnpc, postgresql
...
Priority: optional
Architecture: amd64
Depends: libffi6, libgmp10, libgomp1, libjemalloc${JEVER}, libprocps6, libssl1.1, miniupnpc
License: Apache-2.0
Homepage: https://codaprotocol.com/
Maintainer: o(1)Labs <build@o1labs.org>
Description: Coda Client and Daemon
