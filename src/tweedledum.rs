...
#[no_mangle]
pub extern "C" fn zexe_tweedle_fq_verifier_index_vector_create<'a>() -> *const Vec<*const DlogVerifierIndex<'a, GAffine>> {
    return Box::into_raw(Box::new(Vec::new()));
}

#[no_mangle]
pub extern "C" fn zexe_tweedle_fq_verifier_index_vector_length(v: *const Vec<*const DlogVerifierIndex<GAffine>>) -> i32 {
    let v_ = unsafe { &(*v) };
...
#[no_mangle]
pub extern "C" fn zexe_tweedle_fq_verifier_index_vector_get<'a>(v: *mut Vec<*const DlogVerifierIndex<'a, GAffine>>, i: u32)
-> *const DlogVerifierIndex<GAffine> {
    let v_ = unsafe { &mut (*v) };
...
#[no_mangle]
pub extern "C" fn zexe_tweedle_fq_verifier_index_vector_delete(v: *mut Vec<*const DlogVerifierIndex<GAffine>>) {
