...
pub extern "C" fn zexe_tweedle_fp_index_read<'a>(
    ...
    fn read_compiled<R:Read>(public_inputs: usize, ds: EvaluationDomains<Fp>, m: *const Vec<(Vec<usize>, Vec<Fp>)>, mut r: R) -> IoResult<circuits_dlog::compiled::Compiled<GAffine>> {
...
pub extern "C" fn zexe_tweedle_fp_oracles_create(
    ...
    let (mut sponge, o) = proof.oracles::<
        DefaultFqSponge<TweedledeeParameters>,
        DefaultFrSponge<Fp>,
