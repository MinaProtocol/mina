          ...
          if pre_mesa_upgrade then (
            let zkapp_command =
              ...
              | Mina_transaction.Transaction.Command
                  ...
                  zkapp_command
              | _ ->
                  failwith "Reaching unreachable code"
            in
            let init =
              match
