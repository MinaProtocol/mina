...
module User_command_with_valid_signature = struct
  ...
  module Stable = struct
    module V3 = struct
      type t =
        ( (User_command.Valid.Stable.V3.t[@hash.ignore])
