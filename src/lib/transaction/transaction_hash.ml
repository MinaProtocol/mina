...
let%test "zkApp v1 hash from transaction id" =
  let transaction_id =
    ""
  in
  let expected_hash = "CkpZJ7tCZTcyAMrk4EYSiYyR2fUMZQFFWQHYD2E5vRASwK7NQEBqc" in
  let hash =
    match hash_of_transaction_id transaction_id with
    | Ok hash ->
        to_base58_check hash
