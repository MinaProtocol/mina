...
let () =
  ...
  (let y : M1.Stable.V3.With_version.t =
     M1.Stable.V3.With_version.bin_read_t buf ~pos_ref:(ref 0) in
   assert (y.version = 3);
   assert (y.t = x);
        ...
        module Stable =
          struct
            module V3 =
              struct
                ...
                let bin_shape_t =
                  ...
                  fun a ->
                    (Bin_prot.Shape.top_app _group
                       (Bin_prot.Shape.Tid.of_string "t")) [a]
                let _ = bin_shape_t
                let bin_size_t :
                ...
                let bin_writer_t bin_writer_a =
                  {
                    Bin_prot.Type_class.size =
                      (fun v ->
                         bin_size_t bin_writer_a.Bin_prot.Type_class.size v);
                    write =
                      (fun v ->
                         bin_write_t bin_writer_a.Bin_prot.Type_class.write v)
                  }
                let _ = bin_writer_t
                let __bin_read_t__ :
                  'a .
                  ...
                  fun _of__a ->
                    fun _buf ->
                      fun ~pos_ref ->
                        fun _vint ->
                          Bin_prot.Common.raise_variant_wrong_type
                            "test/versioned_module_good.ml.M2.Stable.V3.t"
                            (!pos_ref)
                let _ = __bin_read_t__
                let bin_read_t :
                    ...
                    vtag_read =
                      (fun buf ->
                         fun ~pos_ref ->
                           fun vtag ->
                             (__bin_read_t__
                                bin_reader_a.Bin_prot.Type_class.read) buf
                               ~pos_ref vtag)
                  }
                let _ = bin_reader_t
                let bin_t bin_a =
                ...
                module With_version =
                  struct
                    ...
                    let bin_shape_typ =
                      ...
                      fun a ->
                        (Bin_prot.Shape.top_app _group
                           (Bin_prot.Shape.Tid.of_string "typ")) [a]
                    let _ = bin_shape_typ
                    let bin_size_typ :
                      'a .
                        'a Bin_prot.Size.sizer -> 'a typ Bin_prot.Size.sizer
                      = fun _size_of_a -> fun v -> bin_size_t _size_of_a v
                    let _ = bin_size_typ
                    let bin_write_typ :
                      'a .
                        'a Bin_prot.Write.writer ->
                          'a typ Bin_prot.Write.writer
                      =
                      fun _write_a ->
                        fun buf ->
                          fun ~pos ->
                            fun v -> (bin_write_t _write_a) buf ~pos v
                    let _ = bin_write_typ
                    let bin_writer_typ bin_writer_a =
                      {
                        Bin_prot.Type_class.size =
                          (fun v ->
                             bin_size_typ
                               bin_writer_a.Bin_prot.Type_class.size v);
                        write =
                          (fun v ->
                             bin_write_typ
                               bin_writer_a.Bin_prot.Type_class.write v)
                      }
                    let _ = bin_writer_typ
                    let __bin_read_typ__ :
                      'a .
                        'a Bin_prot.Read.reader ->
                          (int -> 'a typ) Bin_prot.Read.reader
                      =
                      fun _of__a ->
                        fun buf ->
                          fun ~pos_ref ->
                    ...
                    let bin_read_typ :
                      'a .
                        'a Bin_prot.Read.reader ->
                          'a typ Bin_prot.Read.reader
                      =
                      fun _of__a ->
                        fun buf ->
                          fun ~pos_ref -> (bin_read_t _of__a) buf ~pos_ref
                    let _ = bin_read_typ
                ...
                let bin_read_t x0 buf ~pos_ref  =
                  let With_version.{ version = read_version; t }  =
                    (With_version.bin_read_t x0) buf ~pos_ref in
                  if not (Core_kernel.Int.equal read_version version)
                  then
                    failwith
                      (Core_kernel.sprintf
                ...
                let __bin_read_t__ x0 buf ~pos_ref  i =
                  let With_version.{ version = read_version; t }  =
                    (With_version.__bin_read_t__ x0) buf ~pos_ref i in
                  if not (Core_kernel.Int.equal read_version version)
                  then
                    failwith
                      (Core_kernel.sprintf
                  ...
                  t
                let bin_size_t x0 t =
                  With_version.bin_size_t x0 (With_version.create t)
                let bin_write_t x0 buf ~pos  t =
                  (With_version.bin_write_t x0) buf ~pos
                  ...
                  fun _of__a ->
                    fun _buf ->
                      fun ~pos_ref ->
                        fun _vint ->
                          Bin_prot.Common.raise_variant_wrong_type
                            "test/versioned_module_good.ml.M2.Stable.V2.t"
                            (!pos_ref)
                let _ = __bin_read_t__
                let bin_read_t :
                  'a . 'a Bin_prot.Read.reader -> 'a t Bin_prot.Read.reader =
                  fun _of__a ->
                    fun buf ->
                      fun ~pos_ref ->
                        ...
                        let v_a = _of__a buf ~pos_ref in { b = v_b; a = v_a }
                let _ = bin_read_t
                let bin_reader_t bin_reader_a =
                  {
                    Bin_prot.Type_class.read =
            ...
            module V1 =
              struct
                type t = {
                  a: M1.Stable.V1.t }[@@deriving (bin_io, version)]
                let _ = fun (_ : t) -> ()
                let bin_shape_t =
                  let _group =
                    Bin_prot.Shape.group
                ...
                let (bin_write_t : t Bin_prot.Write.writer) =
                  fun buf ->
                    fun ~pos ->
                      function
                      | { a = v1 } -> M1.Stable.V1.bin_write_t buf ~pos v1
                let _ = bin_write_t
                let bin_writer_t =
                  {
                    Bin_prot.Type_class.size = bin_size_t;
                ...
                let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
                  fun _buf ->
                    fun ~pos_ref ->
                      fun _vint ->
                        Bin_prot.Common.raise_variant_wrong_type
                          "test/versioned_module_good.ml.M2.Stable.V1.t"
                          (!pos_ref)
                let _ = __bin_read_t__
                let (bin_read_t : t Bin_prot.Read.reader) =
                  fun buf ->
          ...
          struct
                ...
                let bin_shape_t =
                  let _group =
                    Bin_prot.Shape.group
                      ...
                      [((Bin_prot.Shape.Tid.of_string "t"), [],
                         (Bin_prot.Shape.record
                            [("a", bin_shape_bool); ("b", bin_shape_int)]))] in
                  (Bin_prot.Shape.top_app _group
                     (Bin_prot.Shape.Tid.of_string "t")) []
                let _ = bin_shape_t
                let (bin_size_t : t Bin_prot.Size.sizer) =
                ...
                let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
                  fun _buf ->
                    fun ~pos_ref ->
                      fun _vint ->
                        Bin_prot.Common.raise_variant_wrong_type
                          "test/versioned_module_good.ml.M3.Stable.V3.t"
                          (!pos_ref)
                let _ = __bin_read_t__
                let (bin_read_t : t Bin_prot.Read.reader) =
                  fun buf ->
                  ...
                  fun _of__a ->
                    fun _buf ->
                      fun ~pos_ref ->
                        fun _vint ->
                          Bin_prot.Common.raise_variant_wrong_type
                            "test/versioned_module_good.ml.M3.Stable.V2.t"
                            (!pos_ref)
                let _ = __bin_read_t__
                let bin_read_t :
                  'a . 'a Bin_prot.Read.reader -> 'a t Bin_prot.Read.reader =
            ...
            module V1 =
              struct
                ...
                let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
                  fun _buf ->
                    fun ~pos_ref ->
                      fun _vint ->
                        Bin_prot.Common.raise_variant_wrong_type
                          "test/versioned_module_good.ml.M3.Stable.V1.t"
                          (!pos_ref)
                let _ = __bin_read_t__
                let (bin_read_t : t Bin_prot.Read.reader) =
                  fun buf ->
                ...
                let _ = __versioned__
                let _ = M1.Stable.V1.__versioned__
                let to_latest { a } = { V3.a = a; b = (if a then 1 else 0) }
                module With_version =
                  struct
                    type typ = t[@@deriving bin_io]
                    let _ = fun (_ : typ) -> ()
...
let () =
  ...
  (let y : M1.Stable.V3.t M2.Stable.V3.With_version.t =
   ...
   assert (y.t = x);
   (let z =
      M2.Stable.V3.bin_read_t M1.Stable.V3.bin_read_t buf ~pos_ref:(ref 0) in
    assert (z = x);
    (try
          ...
          struct
            module V1 =
              struct
                type t = {
                  a: bool ;
                  b: int }[@@deriving (bin_io, version, sexp, equal)]
                let _ = fun (_ : t) -> ()
                let bin_shape_t =
                  let _group =
                    Bin_prot.Shape.group
                ...
                let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
                  fun _buf ->
                    fun ~pos_ref ->
                      fun _vint ->
                        Bin_prot.Common.raise_variant_wrong_type
                          "test/versioned_module_good.ml.M4.Stable.V1.t"
                          (!pos_ref)
                let _ = __bin_read_t__
                let (bin_read_t : t Bin_prot.Read.reader) =
                  fun buf ->
                ...
                let t_of_sexp =
                  (let _tp_loc =
                     "test/versioned_module_good.ml.M4.Stable.V1.t" in
                   function
                       ...
                       let rec iter =
                         ...
                         | (Ppx_sexp_conv_lib.Sexp.List
                             ...
                             ((match field_name with
                               ...
                               | _ ->
                                   if
                                     !Ppx_sexp_conv_lib.Conv.record_check_extra_fields
                         ...
                         | (Ppx_sexp_conv_lib.Sexp.Atom _
                            |Ppx_sexp_conv_lib.Sexp.List _ as sexp)::_ ->
                       ...
                       (iter field_sexps;
                        (match !duplicates with
                         ...
                         | [] ->
                             (match !extra with
                              | _::_ ->
                                  Ppx_sexp_conv_lib.Conv_error.record_extra_fields
                                    _tp_loc (!extra) sexp
                              | [] ->
                   ...
                   | Ppx_sexp_conv_lib.Sexp.Atom _ as sexp ->
                       Ppx_sexp_conv_lib.Conv_error.record_list_instead_atom
                         _tp_loc sexp : Ppx_sexp_conv_lib.Sexp.t -> t)
                let _ = t_of_sexp
                let sexp_of_t =
                  (function
                   | { a = v_a; b = v_b } ->
                       ...
                       let bnds =
                         ...
                         (Ppx_sexp_conv_lib.Sexp.List
                           ...
                           :: bnds in
                       Ppx_sexp_conv_lib.Sexp.List bnds : t ->
                     ...
                     fun b__002_ ->
                       ...
                       then true
                         ...
                         Ppx_compare_lib.(&&)
                           ...
                           (equal_int a__001_.b b__002_.b) : t -> t -> bool)
                let _ = equal
                let to_latest = Fn.id
                module With_version =
                  struct
               ...
               let rec iter =
                 ...
                 | (Ppx_sexp_conv_lib.Sexp.List ((Ppx_sexp_conv_lib.Sexp.Atom
                     ...
                     ((let _ = field_name in
                      ...
                      iter tail)
                 | (Ppx_sexp_conv_lib.Sexp.Atom _|Ppx_sexp_conv_lib.Sexp.List
                    _ as sexp)::_ ->
                     Ppx_sexp_conv_lib.Conv_error.record_only_pairs_expected
                       _tp_loc sexp
                 | [] -> () in
                      ...
                      | [] ->
                          (match ((!a_field), (!b_field)) with
                           ...
                           | _ ->
                               Ppx_sexp_conv_lib.Conv_error.record_undefined_elements
                                 _tp_loc sexp
                                 [((Ppx_sexp_conv_lib.Conv.(=) (!a_field)
                                      None), "a");
                                 ((Ppx_sexp_conv_lib.Conv.(=) (!b_field) None),
                                   "b")]))))
           | Ppx_sexp_conv_lib.Sexp.Atom _ as sexp ->
               Ppx_sexp_conv_lib.Conv_error.record_list_instead_atom _tp_loc
                 sexp : Ppx_sexp_conv_lib.Sexp.t -> t)
        let _ = t_of_sexp
        let sexp_of_t =
          (function
           | { a = v_a; b = v_b } ->
          ...
          (fun a__003_ ->
             fun b__004_ ->
               ...
               then true
                 ...
                 Ppx_compare_lib.(&&) (equal_bool a__003_.a b__004_.a)
                   (equal_int a__003_.b b__004_.b) : t -> t -> bool)
        let _ = equal
      end
  end
module M5 =
          ...
          struct
            module V1 =
              struct
                ...
                include
                  ((Binable.Of_binable)(Core_kernel.Bool.Stable.V1))(Arg)
                module With_version =
                  struct
                    type typ = t[@@deriving bin_io]
                    let _ = fun (_ : typ) -> ()
      ...
      struct
        module Stable =
          struct
            module V1 =
              struct
                type t = M1.Stable.V3.t M2.Stable.V3.t[@@deriving
                                                        (bin_io, version)]
                let _ = fun (_ : t) -> ()
                let bin_shape_t =
                  let _group =
                    Bin_prot.Shape.group
                      ...
                      [((Bin_prot.Shape.Tid.of_string "t"), [],
                         (M2.Stable.V3.bin_shape_t M1.Stable.V3.bin_shape_t))] in
                  (Bin_prot.Shape.top_app _group
                     (Bin_prot.Shape.Tid.of_string "t")) []
                let _ = bin_shape_t
                let (bin_size_t : t Bin_prot.Size.sizer) =
                ...
                let (bin_write_t : t Bin_prot.Write.writer) =
                  fun buf ->
                    fun ~pos ->
                      fun v ->
                        (M2.Stable.V3.bin_write_t M1.Stable.V3.bin_write_t)
                          buf ~pos v
                let _ = bin_write_t
                let bin_writer_t =
                  {
                ...
                let (bin_read_t : t Bin_prot.Read.reader) =
                  fun buf ->
                    fun ~pos_ref ->
                      (M2.Stable.V3.bin_read_t M1.Stable.V3.bin_read_t) buf
                        ~pos_ref
                let _ = bin_read_t
                let bin_reader_t =
                  {
...
let () =
  ...
  (let y : M7.Stable.V1.With_version.t =
     M7.Stable.V1.With_version.bin_read_t buf ~pos_ref:(ref 0) in
   assert (y.version = 1);
   assert (y.t = x);
   (let z = M7.Stable.V1.bin_read_t buf ~pos_ref:(ref 0) in assert (z = x)))
module M8 =
  struct
    include
      struct
          ...
          struct
            module V1 =
              struct
                ...
                module F(X:Y) = struct type y = t
                                       include X end
                include ((F)(X) : sig type y = t end)
                module With_version =
                  struct
                    type typ = t[@@deriving bin_io]
                    let _ = fun (_ : typ) -> ()
