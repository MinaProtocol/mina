          ...
          let _group =
            Bin_prot.Shape.group
              (Bin_prot.Shape.Location.of_string
                 "test/versioned_sig_good.ml:7:6" )
          ...
          let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
           fun _buf ~pos_ref _vint ->
            Bin_prot.Common.raise_variant_wrong_type
              "test/versioned_sig_good.ml.Good.Stable.V2.With_version.t"
              !pos_ref
      ...
      module V1 = struct
        ...
        let bin_shape_t =
          let _group =
            Bin_prot.Shape.group
              (Bin_prot.Shape.Location.of_string
                 "test/versioned_sig_good.ml:13:6" )
        ...
        module With_version = struct
          ...
          let (__bin_read_t__ : (int -> t) Bin_prot.Read.reader) =
           fun _buf ~pos_ref _vint ->
            Bin_prot.Common.raise_variant_wrong_type
              "test/versioned_sig_good.ml.Good.Stable.V1.With_version.t"
              !pos_ref
