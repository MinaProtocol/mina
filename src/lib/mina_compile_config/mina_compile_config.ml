...
let minimum_user_command_fee =
  Currency.Fee.mina_of_string_exn minimum_user_command_fee_string

let default_transaction_fee =
  Currency.Fee.mina_of_string_exn default_transaction_fee_string

let default_snark_worker_fee =
  Currency.Fee.mina_of_string_exn default_snark_worker_fee_string
