...
include Make (struct
  let accounts =
    ...
    ; { pk=
      ...
      (* Offline/Online User Keys: Dmitry D#9033   1 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Kunkomu#6084   2 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Alexander#4542   3 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Kai   4 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: _pk_#9983   5 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Prague#9624   6 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: davidg   7 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: gnossienli#9767   8 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: LatentHero#5466   9 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Alive29#9449   10 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Ilya | Genesis Lab#6248   11 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: aynelis#8284   12 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Stateb#7862   13 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Gordon Freeman#4502   14 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: GRom81#5825   15 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: novy   16 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: ilya_petrov#5431   17 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: y3v63n#0177   18 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: GS   19 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Matt Harrop / Figment Network   20 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Tyler34214#4119   21 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: whataday2day#1271   22 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: viktorbunin#7847   23 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Bison Paul   24 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: WS_Totti#4641   25 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Mikhail#7170   26 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: fullmoon#9069   27 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: RomanS#8785   28 of 28 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
