...
include Make (struct
  let accounts =
    ...
    ; { pk=
      ...
      (* Offline/Online User Keys: Star.LI#0785   1 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: ansonlau3#9535   2 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Dmitry D#9033   3 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Kunkomu#6084   4 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Alexander#4542   5 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Alexander#4542   6 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Kai   7 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: _pk_#9983   8 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Prague#9624   9 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: windows#4629   10 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: davidg   11 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: gnossienli#9767   12 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: LatentHero#5466   13 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Alive29#9449   14 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Ilya | Genesis Lab#6248   15 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: aynelis#8284   16 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: hulio   17 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Stateb#7862   18 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Hunterr84#7710   19 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Gordon Freeman#4502   20 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: GRom81#5825   21 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: DontPanicBurns#7712   22 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: novy   23 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: ilya_petrov#5431   24 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: y3v63n#0177   25 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: GS   26 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Matt Harrop / Figment Network   27 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Tyler34214#4119   28 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: whataday2day#1271   29 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: viktorbunin#7847   30 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Bison Paul   31 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Marius | Ubik Capital#9009   32 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: WS_Totti#4641   33 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Mikhail#7170   34 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: fullmoon#9069   35 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: RomanS#8785   36 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: niuniu#9001   37 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Yfdfcu#2293   38 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: CrisF#3405   39 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: masupilami#4665   40 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: bgibson#0713   41 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: OpenStaking#7372   42 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: hashquark#8413   43 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: ZLH#1783   44 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: AvaLuo#3910   45 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: OranG3   46 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: tarcieri | iqlusion.io#0590   47 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
    ...
    ; { pk=
      ...
      ; balance= 1000
      ; delegate= None }
      (* Offline/Online User Keys: Viktor#0766   48 of 48 *)
    ; { pk=
          Public_key.Compressed.of_base58_check_exn
