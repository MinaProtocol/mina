...
external lagrange_commitment :
  ...
  = "caml_tweedle_fp_urs_lagrange_commitment"
...
external batch_accumulator_check :
  ...
  -> Marlin_plonk_bindings_tweedle_fp.t array
  -> bool
  = "caml_tweedle_fp_urs_batch_accumulator_check"

external h :
  t -> Marlin_plonk_bindings_tweedle_dee.Affine.t
  = "caml_tweedle_fp_urs_h"
