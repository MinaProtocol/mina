...
module Affine = struct
  type t = (Marlin_plonk_bindings_tweedle_fq.t * Marlin_plonk_bindings_tweedle_fq.t) Marlin_plonk_bindings_types.Or_infinite.t
...
external scale: t -> Marlin_plonk_bindings_tweedle_fp.t -> t = "caml_tweedle_dee_scale"
...
external of_affine_coordinates : Marlin_plonk_bindings_tweedle_fq.t -> Marlin_plonk_bindings_tweedle_fq.t -> t = "caml_tweedle_dee_of_affine_coordinates"
