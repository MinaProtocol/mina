...
module Affine = struct
  type t = (Marlin_plonk_bindings_tweedle_fp.t * Marlin_plonk_bindings_tweedle_fp.t) Marlin_plonk_bindings_types.Or_infinite.t
...
external scale: t -> Marlin_plonk_bindings_tweedle_fq.t -> t = "caml_tweedle_dum_scale"
...
external of_affine_coordinates : Marlin_plonk_bindings_tweedle_fp.t -> Marlin_plonk_bindings_tweedle_fp.t -> t = "caml_tweedle_dum_of_affine_coordinates"
