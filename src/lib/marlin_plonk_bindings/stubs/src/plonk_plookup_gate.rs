use plonk_plookup_circuits::gate::{GateType, GateType::*};
use plonk_plookup_circuits::wires::{GateWires, Wire};
...
impl From<&GateType> for CamlPlonkGateType {
    fn from(gate_type: &GateType) -> Self {
        match gate_type {
            ...
            Lookup => CamlPlonkGateType::Lookup,
        }
    }
}
impl From<GateType> for CamlPlonkGateType {
...
impl From<&CamlPlonkGateType> for GateType {
    fn from(gate_type: &CamlPlonkGateType) -> Self {
        match gate_type {
            ...
            CamlPlonkGateType::Lookup => Lookup,
        }
    }
}
impl From<CamlPlonkGateType> for GateType {
