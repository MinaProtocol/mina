...
extern "C" fn caml_pasta_fp_plonk_plookup_gate_vector_finalize(v: ocaml::Value) {
...
ocaml::custom!(CamlPastaFpPlonkGateVector {
    finalize: caml_pasta_fp_plonk_plookup_gate_vector_finalize,
});

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_gate_vector_create() -> CamlPastaFpPlonkGateVector {
    CamlPastaFpPlonkGateVector(Vec::new())
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_gate_vector_add(
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_gate_vector_get(
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_gate_vector_wrap
(
    mut v: CamlPastaFpPlonkGateVectorPtr,
    t: CamlPlonkWire,
    h: CamlPlonkWire,
...
extern "C" fn caml_pasta_fp_plonk_plookup_index_finalize(v: ocaml::Value) {
...
ocaml::custom!(CamlPastaFpPlonkIndex<'a> {
    finalize: caml_pasta_fp_plonk_plookup_index_finalize,
});

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_create(
    ...
    let cs =
        match ConstraintSystem::<Fp>::create(gates, Vec::new(), oracle::pasta::fp5::params(), public as usize)
        {
            None => Err(ocaml::Error::failwith(
                "caml_pasta_fp_plonk_plookup_index_create: could not create constraint system",
            )
            .err()
            .unwrap())?,
            Some(cs) => cs,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_max_degree(index: CamlPastaFpPlonkIndexPtr) -> ocaml::Int {
    index.as_ref().0.srs.get_ref().max_degree() as isize
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_public_inputs(index: CamlPastaFpPlonkIndexPtr) -> ocaml::Int {
    index.as_ref().0.cs.public as isize
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_domain_d1_size(index: CamlPastaFpPlonkIndexPtr) -> ocaml::Int {
    index.as_ref().0.cs.domain.d1.size() as isize
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_domain_d4_size(index: CamlPastaFpPlonkIndexPtr) -> ocaml::Int {
    index.as_ref().0.cs.domain.d4.size() as isize
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_domain_d8_size(index: CamlPastaFpPlonkIndexPtr) -> ocaml::Int {
    index.as_ref().0.cs.domain.d8.size() as isize
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_read(
    ...
    let file = match File::open(path) {
        Err(_) => Err(
            ocaml::Error::invalid_argument("caml_pasta_fp_plonk_plookup_index_read")
                .err()
                .unwrap(),
        )?,
        Ok(file) => file,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_index_write(
    append: Option<bool>,
    ...
    let file = match OpenOptions::new().append(append.unwrap_or(true)).open(path) {
        Err(_) => Err(
            ocaml::Error::invalid_argument("caml_pasta_fp_plonk_plookup_index_write")
                .err()
                .unwrap(),
        )?,
        Ok(file) => file,
