...
use plonk_5_wires_circuits::scalars::RandomOracles;
...
#[ocaml::func]
pub fn caml_pasta_fq_plonk_5_wires_oracles_create(
...
#[ocaml::func]
pub fn caml_pasta_fq_plonk_5_wires_oracles_dummy() -> RandomOracles<Fq> {
    RandomOracles::zero().into()
}

#[ocaml::func]
pub fn caml_pasta_fq_plonk_5_wires_oracles_deep_copy(x: RandomOracles<Fq>) -> RandomOracles<Fq> {
    x
}
