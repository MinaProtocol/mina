...
{
    let mut table = vec![Fq::zero(); 0x100];
    ...
    for x in 0..10 {for y in 0..10
    {
        ...
        table[y | (x << 4)] = Fq::from(xor);
    }}
    return table;
    // init GF(2^8) XOR and GF(2^128) multiplication tables
    for x in 0..10 {for y in 0..0x100
    {
        // GF(2^128) multiplication
        let mul =
        {
