use crate::{
    arkworks::{CamlFp, CamlGroupAffineVesta, CamlPolyCommVesta},
...
pub fn caml_pasta_fp_urs_batch_accumulator_check(
    urs: CamlPastaFpUrs,
    comms: Vec<CamlGroupAffineVesta>,
    chals: Vec<CamlFp>,
) -> bool {
...
#[ocaml::func]
pub fn caml_pasta_fp_urs_h(urs: CamlPastaFpUrs) -> CamlGroupAffineVesta {
    (*urs).h.into()
}
