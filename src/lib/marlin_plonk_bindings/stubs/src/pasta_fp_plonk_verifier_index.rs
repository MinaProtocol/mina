...
use algebra::pasta::{vesta::Affine as GAffine, pallas::Affine as GAffineOther, fp::Fp};
...
pub struct CamlPastaFpPlonkVerifierIndexRaw<'a>(
    pub DlogVerifierIndex<'a, GAffine>,
    pub Rc<SRS<GAffine>>,
);

pub type CamlPastaFpPlonkVerifierIndexRawPtr<'a> =
    ocaml::Pointer<CamlPastaFpPlonkVerifierIndexRaw<'a>>;

extern "C" fn caml_pasta_fp_plonk_verifier_index_raw_finalize(v: ocaml::Value) {
    let v: ocaml::Pointer<CamlPastaFpPlonkVerifierIndexRaw> = ocaml::FromValue::from_value(v);
    unsafe { v.drop_in_place() };
}

ocaml::custom!(CamlPastaFpPlonkVerifierIndexRaw<'a> {
    finalize: caml_pasta_fp_plonk_verifier_index_raw_finalize,
});

pub type CamlPastaFpPlonkVerifierIndex =
    CamlPlonkVerifierIndex<CamlPastaFp, CamlPastaFpUrs, CamlPastaVestaPolyComm<CamlPastaFq>>;
pub type CamlPastaFpPlonkVerifierIndexPtr = CamlPlonkVerifierIndex<
    CamlPastaFpPtr,
    CamlPastaFpUrs,
    CamlPastaVestaPolyComm<CamlPastaFqPtr>,
>;
...
pub fn of_ocaml<'a>(
    ...
    urs: CamlPastaFpUrs,
    evals: CamlPlonkVerificationEvals<CamlPastaVestaPolyComm<CamlPastaFqPtr>>,
    shifts: CamlPlonkVerificationShifts<CamlPastaFpPtr>,
) -> CamlPastaFpPlonkVerifierIndexRaw<'a> {
    ...
    CamlPastaFpPlonkVerifierIndexRaw(index, urs_copy_outer)
}

impl From<CamlPastaFpPlonkVerifierIndexPtr> for CamlPastaFpPlonkVerifierIndexRaw<'_> {
    fn from(index: CamlPastaFpPlonkVerifierIndexPtr) -> Self {
        of_ocaml(
            index.max_poly_size,
            index.max_quot_size,
...
impl From<CamlPastaFpPlonkVerifierIndexPtr> for DlogVerifierIndex<'_, GAffine> {
    fn from(index: CamlPastaFpPlonkVerifierIndexPtr) -> Self {
        CamlPastaFpPlonkVerifierIndexRaw::from(index).0
    }
}
...
pub fn read_raw<'a>(
    urs: CamlPastaFpUrs,
    path: String,
) -> Result<CamlPastaFpPlonkVerifierIndexRaw<'a>, ocaml::Error> {
    match File::open(path) {
        ...
        Ok(file) => {
            ...
            Ok(CamlPastaFpPlonkVerifierIndexRaw(t, Rc::clone(&urs_copy)))
        }
    }
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_raw_read(
    urs: CamlPastaFpUrs,
    path: String,
) -> Result<CamlPastaFpPlonkVerifierIndexRaw<'static>, ocaml::Error> {
    read_raw(urs, path)
}
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_raw_write(
    index: CamlPastaFpPlonkVerifierIndexRawPtr,
    path: String,
) -> Result<(), ocaml::Error> {
...
pub fn caml_pasta_fp_plonk_verifier_index_write(
    ...
    write_raw(&CamlPastaFpPlonkVerifierIndexRaw::from(index).0, path)
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_raw_of_parts(
    max_poly_size: ocaml::Int,
    max_quot_size: ocaml::Int,
    log_size_of_group: ocaml::Int,
    urs: CamlPastaFpUrs,
    evals: CamlPlonkVerificationEvals<CamlPastaVestaPolyComm<CamlPastaFqPtr>>,
    shifts: CamlPlonkVerificationShifts<CamlPastaFpPtr>,
) -> CamlPastaFpPlonkVerifierIndexRaw<'static> {
    of_ocaml(
        max_poly_size,
        max_quot_size,
        log_size_of_group,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_raw_of_ocaml(
    index: CamlPastaFpPlonkVerifierIndexPtr,
) -> CamlPastaFpPlonkVerifierIndexRaw<'static> {
    index.into()
}
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_ocaml_of_raw(
    index: CamlPastaFpPlonkVerifierIndexRawPtr,
) -> CamlPastaFpPlonkVerifierIndex {
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_verifier_index_raw_create(
    ...
    CamlPastaFpPlonkVerifierIndexRaw(verifier_index, urs)
}
...
pub fn caml_pasta_fp_plonk_verifier_index_shifts(
    log2_size: ocaml::Int,
) -> CamlPlonkVerificationShifts<CamlPastaFp> {
