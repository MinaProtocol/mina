...
pub fn read_raw<'a>(
    ...
    match File::open(path) {
        Err(_) => Err(ocaml::Error::invalid_argument(
            "caml_pasta_fp_plonk_plookup_verifier_index_raw_read",
        )
        .err()
        .unwrap()),
        Ok(file) => {
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_read(
    offset: Option<ocaml::Int>,
    urs: CamlPastaFpUrs,
    path: String,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_write(
    append: Option<bool>,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_create(
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_shifts(
    log2_size: ocaml::Int,
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_dummy() -> CamlPastaFpPlonkVerifierIndex {
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_plookup_verifier_index_deep_copy(
