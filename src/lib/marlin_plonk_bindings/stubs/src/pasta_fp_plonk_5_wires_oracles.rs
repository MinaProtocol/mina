...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_5_wires_oracles_create(
...
#[ocaml::func]
pub fn caml_pasta_fp_plonk_5_wires_oracles_dummy() -> RandomOracles<Fp> {
    RandomOracles::zero().into()
}

#[ocaml::func]
pub fn caml_pasta_fp_plonk_5_wires_oracles_deep_copy(x: RandomOracles<Fp>) -> RandomOracles<Fp> {
    x
}
