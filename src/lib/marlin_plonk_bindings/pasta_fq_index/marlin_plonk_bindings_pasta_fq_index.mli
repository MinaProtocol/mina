module Gate_vector : sig
  ...
  external add :
       t
    -> Marlin_plonk_bindings_pasta_fq.t Marlin_plonk_bindings_types.Plonk_gate.t
    -> unit = "caml_pasta_fq_plonk_gate_vector_add"
  ...
  external wrap :
    ...
    -> Marlin_plonk_bindings_types.Plonk_gate.Wire.t
    -> unit = "caml_pasta_fq_plonk_gate_vector_wrap"
end
