...
module Raw = struct
  ...
  external create :
    Marlin_plonk_bindings_pasta_fp_index.t -> t
  ...
  external of_parts :
    ...
    -> Marlin_plonk_bindings_pasta_fp.t Plonk_verification_shifts.t
    = "caml_pasta_fp_plonk_verifier_index_raw_of_parts"
end
...
external to_raw :
  t -> Raw.t
  = "caml_pasta_fp_plonk_verifier_index_raw_of_ocaml"

external of_raw_copy :
  Raw.t -> t
  = "caml_pasta_fp_plonk_verifier_index_ocaml_of_raw"
