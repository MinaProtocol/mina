...
type t =
  { domain: Marlin_plonk_bindings_tweedle_fp.t Plonk_domain.t
  ; max_poly_size: int
  ; max_quot_size: int
  ; urs: Marlin_plonk_bindings_tweedle_fp_urs.t
  ; evals:
      Marlin_plonk_bindings_tweedle_fp_urs.Poly_comm.t
      Plonk_verification_evals.t
  ; shifts: Marlin_plonk_bindings_tweedle_fp.t Plonk_verification_shifts.t }
