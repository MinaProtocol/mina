...
external write : t -> string -> unit = "caml_pasta_fq_urs_write"

external read : string -> t option = "caml_pasta_fq_urs_read"
...
external batch_accumulator_check :
  ...
  -> bool
  = "caml_pasta_fq_urs_batch_accumulator_check"

external h :
  t -> Marlin_plonk_bindings_pasta_pallas.Affine.t
  = "caml_pasta_fq_urs_h"
