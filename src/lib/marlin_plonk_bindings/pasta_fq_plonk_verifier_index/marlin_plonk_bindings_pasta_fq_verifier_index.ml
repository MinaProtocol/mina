...
module Raw = struct
  ...
  external create :
    ...
    = "caml_pasta_fq_plonk_verifier_index_raw_create"

  external read :
    Marlin_plonk_bindings_pasta_fq_urs.t -> string -> t
    = "caml_pasta_fq_plonk_verifier_index_raw_read"

  external write :
    t -> string -> unit
    = "caml_pasta_fq_plonk_verifier_index_raw_write"
  ...
  external of_parts :
    ...
    = "caml_pasta_fq_plonk_verifier_index_raw_of_parts"
end
...
external to_raw :
  t -> Raw.t
  = "caml_pasta_fq_plonk_verifier_index_raw_of_ocaml"

external of_raw_copy :
  Raw.t -> t
  = "caml_pasta_fq_plonk_verifier_index_ocaml_of_raw"
