...
module Make (Rpc_intf : Mina_base.Rpc_intf.Rpc_interface_intf) :
  ...
  module Instance = struct
    ...
    let set_node_status_data _ _ = Deferred.Or_error.ok_unit

    let get_peer_node_status_data _ _ =
      Deferred.Or_error.error_string "fake node status data: Not implemented"
