...
module Network = struct
  ...
  let libp2p_daemon_IPC_delay : Gauge.t =
    let help = "Delay in daemon receiving gossip messages in ns" in
    Gauge.v "libp2p_daemon_IPC_delay" ~help ~namespace ~subsystem
