                        ...
                        upon
                          ...
                          (fun result ->
                            ...
                            | Some ledger ->
                                ...
                                in
                                don't_wait_for
                                @@ go account_state_tbl ~vk ~prover 0 tm_next 0 ) ;
        ...
        ~resolve:(fun { ctx = mina; _ } () handle ->
          ...
          try
            ...
            | Some ivar ->
                ...
                @@ Ok
                     (sprintf
                        "Requesting stop of scheduled transactions with handle \
                         %s"
                        handle )
          with _ ->
            return
            @@ Error
                 (sprintf "Not a valid scheduled transactions handle: %s" handle)
          )
