...
let zkapp_predicate = salt zkapp_predicate

let zkapp_predicate_account = salt zkapp_predicate_account

let zkapp_predicate_protocol_state = salt zkapp_predicate_protocol_state
