...
let (example_weights : Gate_weights.t) =
  { w_l= [[Fr.of_int 1; Fr.of_int 2]; [Fr.of_int 3; Fr.of_int 4]]
  ; w_r= [[Fr.of_int 5; Fr.of_int 6]; [Fr.of_int 7; Fr.of_int 8]]
  ; w_o= [[Fr.of_int 9; Fr.of_int 10]; [Fr.of_int 11; Fr.of_int 12]] }
...
let satisfied_test =
  QCheck.Test.make ~count:10 ~name:"satisfied test"
    ...
    (fun l ->
      ...
      let zero_coeff =
        List.nth_exn
          (Bivariate_fr_laurent.coeffs t)
          (0 - Bivariate_fr_laurent.deg t)
      in
