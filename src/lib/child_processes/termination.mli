...
module Table : sig
  ...
  type 'a merge_into_action =
        'a
        Core_kernel__Hashable.Make_binable(Core_kernel.Pid).Table
        .merge_into_action =
    | Remove
    | Set_to of 'a
...
val process_kind_of_yojson :
  Yojson.Safe.t -> process_kind Ppx_deriving_yojson_runtime.error_or
