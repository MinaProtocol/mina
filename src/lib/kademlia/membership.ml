  ...
  ( module struct
    ...
    let%test_module "Trust" =
      ( module struct
         ...
         *       trust_system := Unix.Inet_addr.Set.add !trust_system normal_addr.host ;
         ...
         *               Haskell_trust.first_peers new_banner_node
         *             in
         *             printf !"%{sexp:Peer.t list}" peers_after_reconnect ;
         *             List.length peers_after_reconnect <> 0
         *             && List.hd_exn peers_after_reconnect = normal_addr )
         *       in
