...
module Per_proof_witness_kimchi : sig
open Pickles_types
...
module type Per_proof_witness_sig =  sig
open Pickles_types
module Impl = Impls.Step
module One_hot_vector = One_hot_vector.Step
...
module Make : functor (Step_verifier : Step_verifier.Step_verifier_sig) -> Per_proof_witness_sig