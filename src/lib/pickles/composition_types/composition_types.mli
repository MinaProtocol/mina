...
module Wrap : sig
  module Proof_state : sig
    ...
    module Deferred_values : sig
      module Plonk : sig
        ...
        module In_circuit : sig
          ...
          val map_challenges :
               ('a, 'b, 'c, ('b, 'e) Opt.t, 'bool) t
            -> f:('a -> 'f)
            -> scalar:('b -> 'g)
            -> ('f, 'g, 'c, ('g, 'e) Opt.t, 'bool) t

          val map_fields :
               ('a, 'b, 'c, ('d, 'e) Opt.t, 'bool) t
            -> f:('c -> 'f)
            -> ('a, 'b, 'f, ('d, 'e) Opt.t, 'bool) t
    ...
    val to_minimal :
         ('a, 'b, 'c, 'd, 'bool, 'e, 'f, 'g, 'h) In_circuit.t
      -> to_option:('d -> 'b option)
  ...
  *)
  module Statement : sig
    ...
    val to_minimal :
         ('a, 'b, 'c, 'd, 'bool, 'e, 'f, 'g, 'h, 'i) In_circuit.t
      -> to_option:('d -> 'b option)
