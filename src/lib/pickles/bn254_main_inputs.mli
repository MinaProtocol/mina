...
module Inner_curve : sig
  module Inputs : sig
    module Impl = Impls.Bn254.Impl

    module Params : sig
      val a : Kimchi_bn254.Basic.Bn254_fp.t

      val b : Kimchi_bn254.Basic.Bn254_fp.t

      val one : Kimchi_bn254.Basic.Bn254_fp.t * Kimchi_bn254.Basic.Bn254_fp.t
...
module Ops : module type of Plonk_curve_ops.Make (Impls.Bn254) (Inner_curve)
