...
module Failure = struct
  ...
  type tt = t [@@deriving sexp, yojson, equal, compare, hash]
  ...
  module Collection = struct
    ...
    type t = tt list list [@@deriving equal, compare, yojson, sexp, hash]
...
type t = Stable.Latest.t = Applied | Failed of Failure.Collection.t
[@@deriving sexp, yojson, equal, compare]
