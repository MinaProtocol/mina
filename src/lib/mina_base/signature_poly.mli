module Stable : sig
  module V1 : sig
    ...
    val t_of_sexp :
      ...
      -> (Ppx_sexp_conv_lib.Sexp.t -> 'scalar)
      -> Ppx_sexp_conv_lib.Sexp.t
      -> ('field, 'scalar) t

    val sexp_of_t :
         ('field -> Ppx_sexp_conv_lib.Sexp.t)
      -> ('scalar -> Ppx_sexp_conv_lib.Sexp.t)
      -> ('field, 'scalar) t
      -> Ppx_sexp_conv_lib.Sexp.t
    ...
    val hash_fold_t :
      ...
      -> (Ppx_hash_lib.Std.Hash.state -> 'scalar -> Ppx_hash_lib.Std.Hash.state)
      -> Ppx_hash_lib.Std.Hash.state
      -> ('field, 'scalar) t
      -> Ppx_hash_lib.Std.Hash.state

    module With_version : sig
      type ('field, 'scalar) typ = ('field, 'scalar) t
      ...
      val bin_size_typ :
        ...
        -> 'scalar Core_kernel.Bin_prot.Size.sizer
        -> ('field, 'scalar) typ Core_kernel.Bin_prot.Size.sizer

      val bin_write_typ :
           'field Core_kernel.Bin_prot.Write.writer
        -> 'scalar Core_kernel.Bin_prot.Write.writer
        -> ('field, 'scalar) typ Core_kernel.Bin_prot.Write.writer
      ...
      val __bin_read_typ__ :
        ...
        -> 'scalar Core_kernel.Bin_prot.Read.reader
        -> (int -> ('field, 'scalar) typ) Core_kernel.Bin_prot.Read.reader

      val bin_read_typ :
           'field Core_kernel.Bin_prot.Read.reader
        -> 'scalar Core_kernel.Bin_prot.Read.reader
        -> ('field, 'scalar) typ Core_kernel.Bin_prot.Read.reader
      ...
      type ('field, 'scalar) t = { version : int; t : ('field, 'scalar) typ }
      ...
      val bin_size_t :
           'field Core_kernel.Bin_prot.Size.sizer
        -> 'scalar Core_kernel.Bin_prot.Size.sizer
        -> ('field, 'scalar) t Core_kernel.Bin_prot.Size.sizer

      val bin_write_t :
           'field Core_kernel.Bin_prot.Write.writer
        -> 'scalar Core_kernel.Bin_prot.Write.writer
        -> ('field, 'scalar) t Core_kernel.Bin_prot.Write.writer
      ...
      val __bin_read_t__ :
           'field Core_kernel.Bin_prot.Read.reader
        -> 'scalar Core_kernel.Bin_prot.Read.reader
        -> (int -> ('field, 'scalar) t) Core_kernel.Bin_prot.Read.reader

      val bin_read_t :
           'field Core_kernel.Bin_prot.Read.reader
        -> 'scalar Core_kernel.Bin_prot.Read.reader
        -> ('field, 'scalar) t Core_kernel.Bin_prot.Read.reader
...
type ('field, 'scalar) t = ('field, 'scalar) Stable.V1.t
