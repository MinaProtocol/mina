...
val deriver :
     (< contramap :
          (   (Auth_required.t, Protocol_version.t) Poly.t
           -> (Auth_required.t, Protocol_version.t) Poly.t )
          ref
      ; graphql_arg :
          (   unit
      ...
      ; graphql_arg_accumulator :
          ...
          ref
      ; graphql_creator :
          ('a -> (Auth_required.t, Protocol_version.t) Poly.t) ref
      ; graphql_fields :
          (Auth_required.t, Protocol_version.t) Poly.t
      ...
      ; nullable_graphql_fields :
          (Auth_required.t, Protocol_version.t) Poly.t option
          Fields_derivers_zkapps.Graphql.Fields.Input.T.t
          ref
      ; of_json :
      ...
      ; to_json_accumulator :
          ( string
          * ((Auth_required.t, Protocol_version.t) Poly.t -> Yojson.Safe.t) )
          option
          list
          ref
      ; skip : bool ref
