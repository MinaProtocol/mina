...
libff::GT<ppT>* 
camlsnark_mnt6_bg_verification_key_alpha_beta(
    r1cs_bg_ppzksnark_verification_key<ppT>* vk
) {
...
libff::G2<ppT>* 
camlsnark_mnt6_bg_verification_key_delta (
    r1cs_bg_ppzksnark_verification_key<ppT>* vk
) {
...
libff::G2<ppT>* 
camlsnark_mnt6_bg_verification_key_gamma (
    r1cs_bg_ppzksnark_verification_key<ppT>* vk
) {
...
std::vector< libff::G1<ppT> >*
camlsnark_mnt6_bg_verification_key_query(
    r1cs_bg_ppzksnark_verification_key<ppT> *vk)
{
