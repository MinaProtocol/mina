...
For a comprehensive overview of all node network traffic including message sizes, latency requirements, bandwidth estimates, and monitoring guidance, see [RFC 0066](../../../rfcs/0066-network-traffic-documentation.md).
