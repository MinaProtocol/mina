...
module Rpcs : sig
  ...
  module Get_node_status_data : sig
    module Node_status_data : sig
      [%%versioned:
      module Stable : sig
        module V1 : sig
          type t =
    ...
    type response = Node_status_data.t Or_error.t [@@deriving to_yojson]
  end
...
val get_peer_node_status_data :
     t
  -> Network_peer.Peer.t
  -> Rpcs.Get_node_status_data.Node_status_data.t Deferred.Or_error.t
...
val create :
  ...
  -> get_node_status_data:(   Rpcs.Get_node_status_data.query
                              Envelope.Incoming.t
