  ...
  module V4 = struct
    module T = struct
      ...
      type response =
        ...
        * Mina_state.Protocol_state.Value.Stable.V4.t list )
        option
...
module Get_transition_chain = struct
  ...
  module V3 = struct
    module T = struct
      ...
      type response = Mina_block.Stable.V4.t list option
...
module Get_completed_snarks = struct
  ...
  module Master = struct
    ...
    module T = struct
      ...
      type response = Transaction_snark_work.Stable.V4.t list option
    end
...
module Get_ancestry = struct
  ...
  module V4 = struct
    module T = struct
      ...
      type response =
        ( Mina_block.Stable.V4.t
        , State_body_hash.Stable.V1.t list * Mina_block.Stable.V4.t )
