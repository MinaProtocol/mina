...
val wrap :
  ...
  -> (   ( Impls.Wrap.Impl.Field.t
         ...
         , Impls.Wrap.Impl.Field.t Vinegar_types.Shifted_value.Type1.t
         , ( Impls.Wrap.Impl.Field.t Vinegar_types.Shifted_value.Type1.t
  ...
  -> actual_wrap_domains:(Core_kernel.Int.t, 'c) Vinegar_types.Vector.t
...
val combined_inner_product :
  ...
  -> actual_proofs_verified:
       (module Vinegar_types.Nat.Add.Intf with type n = 'actual_proofs_verified)
  -> ( Backend.Tick.Field.t array * Backend.Tick.Field.t array
     , Backend.Tick.Field.t array * Backend.Tick.Field.t array )
     Vinegar_types.Plonk_types.All_evals.With_public_input.t
  -> old_bulletproof_challenges:
       ( (Backend.Tick.Field.t, 'a) Vinegar_types.Vector.t
       , 'actual_proofs_verified )
       Vinegar_types.Vector.t
...
module Type1 :
    module type of
      Plonk_checks.Make
        (Vinegar_types.Shifted_value.Type1)
