...
module Make
    (A : Vinegar_types.Poly_types.T0) (A_value : sig
      type t
    end)
    (Max_proofs_verified : Vinegar_types.Nat.Add.Intf_transparent) : sig
  val f :
       ?handler:
    ...
    -> prevs_length:('prev_vars, 'prevs_length) Vinegar_types.Hlist.Length.t
    -> self:('a, 'b, 'c, 'd) Tag.t
    -> step_domains:
         (Import.Domains.t, 'self_branches) Vinegar_types.Vector.t Promise.t
    ...
    -> ( ( 'value
         ...
         , (Backend.Tock.Curve.Affine.t, 'prevs_length) Vinegar_types.Vector.t
       ...
       * 'ret_value
       * 'auxiliary_value
       * (int, 'prevs_length) Vinegar_types.Vector.t )
       Promise.t
end
