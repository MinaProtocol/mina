...
module Mina_numbers = struct
  ...
  include Assert_equal0V1 (O.Global_slot_since_genesis.Stable) (W.Global_slot_since_genesis)
  include Assert_equal0V1 (O.Global_slot_since_hard_fork.Stable) (W.Global_slot_since_hard_fork)
