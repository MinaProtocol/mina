...
module Stable : sig
  module V1 : sig
    ...
    val to_yojson :
      t -> [> `Assoc of (Id.t * [> `Int of int | `String of Id.t ]) list ]

    val of_yojson :
         [> `Assoc of
            ( Core.String.t
            , [> `Int of int | `String of Id.t ] )
            Core.List.Assoc.t ]
      -> (t, Id.t) Core.Result.t
...
val of_yojson :
     [> `Assoc of
        (Core.String.t, [> `Int of int | `String of Id.t ]) Core.List.Assoc.t
     ]
  -> (t, Id.t) Core.Result.t
...
module Table : sig
  ...
  val validate :
    name:(key -> Id.t) -> 'b Base__.Validate.check -> 'b t Base__.Validate.check
...
val create :
  Core.Unix.Inet_addr.Blocking_sexp.t -> libp2p_port:int -> peer_id:Id.t -> t

val to_discovery_host_and_port : t -> Core.Host_and_port.t

val to_string : t -> Id.t

val to_multiaddr_string : t -> Id.t

val pretty_list : t list -> Id.t

module Event : sig
  type t = Connect of Table.key list | Disconnect of Table.key list
...
module Display : sig
  module Stable : sig
    module V1 : sig
      type t = { host : Id.t; libp2p_port : int; peer_id : Id.t }
      ...
      module Fields : sig
        ...
        val create : host:Id.t -> libp2p_port:int -> peer_id:Id.t -> t
  ...
  type t = Stable.V1.t = { host : Id.t; libp2p_port : int; peer_id : Id.t }
