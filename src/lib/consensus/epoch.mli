...
val slot_start_time : constants:Constants.t -> t -> Slot.t -> Block_time.t

val slot_end_time : constants:Constants.t -> t -> Slot.t -> Block_time.t

val epoch_and_slot_of_time_exn :
  constants:Constants.t -> Block_time.t -> t * Slot.t

val diff_in_slots : constants:Constants.t -> t * Slot.t -> t * Slot.t -> int64

val incr : constants:Constants.t -> t * Slot.t -> t * Unsigned.UInt32.t
