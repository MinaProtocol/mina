module T : Mina_numbers__Nat.Intf.UInt32
...
val typ : (T.Checked.t, t) Snark_params.Tick.Typ.t
...
val in_seed_update_range : constants:Constants.t -> t -> bool

module Checked : sig
  type var = T.Checked.var

  val constant : T.t -> var
  ...
  val typ : (var, T.t) Snark_params.Tick.Typ.t
...
val gen : Constants.t -> Unsigned.UInt32.t Core_kernel__Quickcheck.Generator.t
