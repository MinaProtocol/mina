module type Full = sig
  ...
  val of_slot_number :
    constants:Constants.t -> Mina_numbers.Global_slot_since_genesis.t -> t
  ...
  module Checked : sig
    ...
    val sub :
      t -> t -> Mina_numbers.Global_slot_since_genesis.Checked.t Checked.t
  end
  ...
  module For_tests : sig
    val of_global_slot : t -> Mina_numbers.Global_slot_since_genesis.t -> t
  end
end
