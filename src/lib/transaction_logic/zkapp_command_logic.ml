...
module type Account_intf = sig
  ...
  module Permissions : sig
    ...
    val set_verification_key_version : t -> version
...
module type Inputs_intf = sig
  ...
  module Version : Version_intf with type bool := Bool.t
  ...
  and Account :
    (Account_intf
      with type Permissions.controller := Controller.t
       and type Permissions.version := Version.t
    ...
    *)
    ...
    let a, local_state =
      ...
      let older_than_current_version =
        Version.older_than_current
          (Account.Permissions.set_verification_key_version a)
      in
