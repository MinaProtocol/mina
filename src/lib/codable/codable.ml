...
module Make_base58_check_old (T : sig
...
module Make_base58_check_new (T : sig
  type t [@@deriving bin_io]
...
struct
  module Base58_check = Base58_check.Base58_check_new.Make (T)
...
module Make_base58_check = Make_base58_check_old
