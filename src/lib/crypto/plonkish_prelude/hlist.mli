...
(** Map arity 0 to 5: [let e05 t = fun _ _ _ _ _ -> t] *)
...
(** Operations on heterogeneous lists whose content type varies over five
    type parameters.
...
(** Operations on heterogeneous lists whose content type varies over six
    type parameters.
