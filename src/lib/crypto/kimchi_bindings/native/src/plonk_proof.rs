...
use crate::wasm_flat_vector::FlatVector;
     ...
     $field_name: ident
        ...
        paste! {
            ...
            impl [<Wasm $field_name:camel ProverProof>] {
                ...
                #[wasm_bindgen(getter)]
                pub fn public_(&self) -> FlatVector<$WasmF> {
                    self.public.clone()
                }
                #[wasm_bindgen(getter)]
                ...
                #[wasm_bindgen(setter)]
                pub fn set_public_(&mut self, public_: FlatVector<$WasmF>) {
                    self.public = public_
                }
                #[wasm_bindgen(setter)]
            ...
            impl [<Wasm $field_name:camel RuntimeTable>] {
                #[wasm_bindgen(constructor)]
                pub fn new(id: i32, data: FlatVector<$WasmF>) -> WasmRuntimeTable {
            ...
            pub fn [<$name:snake _create>](
                ...
                prev_challenges: FlatVector<$WasmF>,
