     ...
     $field_name: ident) => {
        ...
        paste! {
            ...
            pub struct [<Wasm $field_name:camel Oracles>] {
                ...
                pub p_eval1: $WasmF,
                #[wasm_bindgen(skip)]
                pub opening_prechallenges: FlatVector<$WasmF>,
            ...
            impl [<Wasm $field_name:camel Oracles>] {
                ...
                pub fn new(
                    ...
                    p_eval0: $WasmF,
                    p_eval1: $WasmF,
                    opening_prechallenges: FlatVector<$WasmF>,
                    digest_before_evaluations: $WasmF) -> Self {
                    Self {o, p_eval0, p_eval1, opening_prechallenges, digest_before_evaluations}
                }

                #[wasm_bindgen(getter)]
                pub fn opening_prechallenges(&self) -> FlatVector<$WasmF> {
                    self.opening_prechallenges.clone()
                }

                #[wasm_bindgen(setter)]
                pub fn set_opening_prechallenges(&mut self, x: FlatVector<$WasmF>) {
