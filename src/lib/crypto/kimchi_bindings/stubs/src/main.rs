    ...
    decl_module!(w, env, "Protocol", {
        ...
        decl_module!(w, env, "SRS", {
            decl_module!(w, env, "Fp", {
                ...
                decl_func!(w, env, caml_fp_srs_add_lagrange_basis_with_cache=> "add_lagrange_basis_with_cache");
            ...
            decl_module!(w, env, "Fq", {
                ...
                decl_func!(w, env, caml_fq_srs_add_lagrange_basis_with_cache=> "add_lagrange_basis_with_cache");
