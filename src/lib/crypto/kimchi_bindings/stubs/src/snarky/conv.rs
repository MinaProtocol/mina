...
macro_rules! impl_custom_clone {
    ($CamlVar: ty, $CamlF: ty, $F: ty) => {
        ...
        pub fn basic_conv(x: &BasicInput<$CamlVar, $CamlF>) -> BasicInput<FieldVar<$F>, $F> {
            let BasicInput {
                l: (l0, l1),
                r: (r0, r1),
                o: (o0, o1),
        ...
        pub fn ec_add_complete_conv(
            x: &EcAddCompleteInput<$CamlVar>,
        ...
        pub fn ec_scale_round(x: &ScaleRound<$CamlVar>) -> ScaleRound<FieldVar<$F>> {
            let ScaleRound {
                accs,
                bits,
                ss,
        ...
        pub fn ec_endoscale_round(x: &EndoscaleRound<$CamlVar>) -> EndoscaleRound<FieldVar<$F>> {
            let EndoscaleRound {
                xt,
                yt,
                xp,
        ...
        pub fn ec_endoscale_conv(x: &EcEndoscaleInput<$CamlVar>) -> EcEndoscaleInput<FieldVar<$F>> {
        ...
        pub fn ec_endoscale_scalar_conv(
            x: &EndoscaleScalarRound<$CamlVar>,
