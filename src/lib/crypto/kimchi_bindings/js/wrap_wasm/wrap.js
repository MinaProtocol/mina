// Provides: wrap_wasm
// Requires: wrap_wasm_proof,wrap_wasm_oracles,wrap_wasm_prover_index,tsBindings,wrap_wasm_verifier_index,wrap_wasm_srs
function wrap_wasm(plonk_wasm){
  ...
  plonk_intf.tsRustConversion = tsRustConversion;
