...
var fp_oracles_dummy = function () {
  return tsRustConversion.fp.oraclesFromRust(kimchi_ffi.fp_oracles_dummy());
};
...
var fp_oracles_deep_copy = function (x) {
  return tsRustConversion.fp.oraclesFromRust(
    kimchi_ffi.fp_oracles_deep_copy(tsRustConversion.fp.oraclesToRust(x))
  );
};
...
var fq_oracles_dummy = function () {
  return tsRustConversion.fq.oraclesFromRust(kimchi_ffi.fq_oracles_dummy());
};
...
var fq_oracles_deep_copy = function (x) {
  return tsRustConversion.fq.oraclesFromRust(
    kimchi_ffi.fq_oracles_deep_copy(tsRustConversion.fq.oraclesToRust(x))
  );
};
