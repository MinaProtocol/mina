/* global kimchi_ffi, tsRustConversion, caml_jsstring_of_string */
...
var caml_pasta_fp_plonk_index_serialize = function (index) {
    ...
    return kimchi_ffi.prover_index_fp_serialize(index);
};
...
var caml_pasta_fp_plonk_index_deserialize = function (index) {
    ...
    return kimchi_ffi.prover_index_fp_deserialize(index);
};
...
var caml_pasta_fq_plonk_index_serialize = function (index) {
    ...
    return kimchi_ffi.prover_index_fq_serialize(index);
};
...
var caml_pasta_fq_plonk_index_deserialize = function (index) {
    ...
    return kimchi_ffi.prover_index_fq_deserialize(index);
};
