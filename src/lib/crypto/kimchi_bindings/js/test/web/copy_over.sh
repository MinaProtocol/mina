...
cp -r -t _build/default/src/lib/marlin_plonk_bindings/js/test/web _build/default/src/lib/marlin_plonk_bindings/js/web/kimchi_wasm* _build/default/src/lib/marlin_plonk_bindings/js/web/snippets
