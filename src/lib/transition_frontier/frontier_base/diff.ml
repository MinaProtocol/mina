...
module Root_transition = struct
  ...
  module Lite_binable = struct
    ...
    module Stable = struct
      ...
      module V4 = struct
        ...
        let to_latest : t -> V5.t =
         fun { new_root; garbage; just_emitted_a_proof } ->
          { V5.new_root = Root_data.Limited.Stable.V3.to_latest new_root
          ; garbage
  ...
  module Lite = struct
    ...
    module Stable = struct
      ...
      module V4 = struct
        type t = Binable_arg.Stable.V4.t
        ...
        let to_latest = Binable_arg.Stable.V4.to_latest
      end
    end]
  end
end
