...
module Stable = struct
  ...
  module V5 = struct
    type t = T.t =
      ...
      ; protocol_state : Protocol_state.Value.Stable.V4.t
      ; protocol_state_proof : Mina_base.Proof.Stable.V3.t
      ; staged_ledger_diff : Legacy_format.Staged_ledger_diff.Stable.V3.t
