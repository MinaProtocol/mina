...
let sample_block_sexp =
  {sexp|
((scheduled_time 1674563847442)
 (protocol_state
  ((previous_state_hash
    25615995500651126692640506889316657461198629863905478975779029548673556309401)
   (body
    ((genesis_state_hash
      25615995500651126692640506889316657461198629863905478975779029548673556309401)
     (blockchain_state
      ((staged_ledger_hash
        ((non_snark
          ((ledger_hash
            6678436441585702904037868995833227678214238318728478306634187000944146007347)
           (aux_hash
            "\255\"\252\219\156\135\182\170\189a\004\237\163\018=\138\245\173\021t\028\173\004\171r\006\001\219\132$Bv")
           (pending_coinbase_aux
            "\147\141\184\201\248,\140\181\141?>\244\253%\0006\164\141&\167\018u=/\222Z\189\003\168\\\171\244")))
         (pending_coinbase_hash
          17441490688447563054931915816840973400214289936168464317889230594357225829640)))
       (genesis_ledger_hash
        26191292145112788763781658447516412659152247313155115635152138427379384823993)
       (registers
        ((ledger
          26191292145112788763781658447516412659152247313155115635152138427379384823993)
  ...
  {json|
{
  ...
  "data": {
    "scheduled_time": "1674563847442",
    "protocol_state": {
      "previous_state_hash": "3NLCT5HULGPu6jwdYq6SuWZDYYYYGDqRHfpXvq1RehfgnrfcmYrq",
      "body": {
        "genesis_state_hash": "3NLCT5HULGPu6jwdYq6SuWZDYYYYGDqRHfpXvq1RehfgnrfcmYrq",
        "blockchain_state": {
          "staged_ledger_hash": {
            "non_snark": {
              "ledger_hash": "jwVBdmdmrJRc8dcosinwSCf2dRkxkxVhfWRzTEPYTo6JPYp7MrJ",
              "aux_hash": "W9nbRqQEnKEbH1iJetC7MqYxeMhzEvZGBYJ7cJyUGUQpnXkfTc",
              "pending_coinbase_aux": "XH9htC21tQMDKM6hhATkQjecZPRUGpofWATXPkjB5QKxpTBv7H"
            },
            "pending_coinbase_hash": "2mzaSXZpZD5pLSqxMYwWTtS4vLY1vVAfcJPSUKzyVbhRE5itvQdB"
          },
          "genesis_ledger_hash": "jxWPBuvHMLLJx2bvoZJK454oX8vJP5i3e1h9B5dtVcH72Xz9zPV",
          "registers": {
            "ledger": "jxWPBuvHMLLJx2bvoZJK454oX8vJP5i3e1h9B5dtVcH72Xz9zPV",
        ...
        "consensus_state": {
          ...
          "staking_epoch_data": {
            "ledger": {
              "hash": "jxWPBuvHMLLJx2bvoZJK454oX8vJP5i3e1h9B5dtVcH72Xz9zPV",
              "total_currency": "10016100000000000"
            },
          ...
          "next_epoch_data": {
            ...
            "start_checkpoint": "3NK2tkzqqK5spR2sZ7tujjqPksL45M3UUrcA4WhCkeiPtnugyE2x",
            "lock_checkpoint": "3NLCT5HULGPu6jwdYq6SuWZDYYYYGDqRHfpXvq1RehfgnrfcmYrq",
            "epoch_length": "3"
          },
          "has_ancestor_in_same_checkpoint_window": true,
    ...
    "delta_transition_chain_proof": [
      "jxGAJKaQaKPP3oBTzkd9bWromLN5crRVoy6mqCPFSNrhDZB5JeB",
      []
    ],
    "accounts_accessed": [
      [
