...
include module type of Validation_types with type ('a, 'b, 'c, 'd, 'e, 'f, 'g) t := ('a, 'b, 'c, 'd, 'e, 'f, 'g) t
...
val validate_time_received :
  ...
  -> ([`Time_received] * unit Truth.false_t, 'a, 'b, 'c, 'd, 'e, 'f) with_block
  -> (([`Time_received] * unit Truth.true_t, 'a, 'b, 'c, 'd, 'e, 'f) with_block, [> `Invalid_time_received of [`Too_early | `Too_late of int64]]) result
...
val validate_genesis_protocol_state :
  ...
  -> ('a, [`Genesis_state] * unit Truth.false_t, 'b, 'c, 'd, 'e, 'f) with_block
  -> (('a, [`Genesis_state] * unit Truth.true_t, 'b, 'c, 'd, 'e, 'f) with_block, [> `Invalid_genesis_protocol_state]) result
...
val validate_proofs :
  ...
  -> (('a, 'b, [`Proof] * unit Truth.true_t, 'c, 'd, 'e, 'f) with_block list, [> `Invalid_proof | `Verifier_error of Error.t]) Deferred.Result.t

val validate_single_proof :
     verifier:Verifier.t
  -> ('a, 'b, [`Proof] * unit Truth.false_t, 'c, 'd, 'e, 'f) with_block
  -> (('a, 'b, [`Proof] * unit Truth.true_t, 'c, 'd, 'e, 'f) with_block, [> `Invalid_proof | `Verifier_error of Error.t]) Deferred.Result.t
...
val extract_delta_block_chain_witness :
     ('a, 'b, 'c, [`Delta_block_chain] * State_hash.t Non_empty_list.t Truth.true_t, 'd, 'e, 'f) t
  -> State_hash.t Non_empty_list.t

val validate_delta_block_chain :
     ('a, 'b, 'c, [`Delta_block_chain] * State_hash.t Non_empty_list.t Truth.false_t, 'd, 'e, 'f) with_block
  -> (('a, 'b, 'c, [`Delta_block_chain] * State_hash.t Non_empty_list.t Truth.true_t, 'd, 'e, 'f) with_block, [> `Invalid_delta_block_chain_proof]) result

val skip_delta_block_chain_validation :
     [`This_block_was_not_received_via_gossip]
  -> ('a, 'b, 'c, [`Delta_block_chain] * State_hash.t Non_empty_list.t Truth.false_t, 'd, 'e, 'f) with_block
  -> ('a, 'b, 'c, [`Delta_block_chain] * State_hash.t Non_empty_list.t Truth.true_t, 'd, 'e, 'f) with_block
...
val validate_frontier_dependencies :
  ...
  -> ('a, 'b, 'c, 'd, [`Frontier_dependencies] * unit Truth.false_t, 'e, 'f) with_block
  -> ( ('a, 'b, 'c, 'd, [`Frontier_dependencies] * unit Truth.true_t, 'e, 'f) with_block
     , [> `Already_in_frontier | `Not_selected_over_frontier_root | `Parent_missing_from_frontier] )
     result

val skip_frontier_dependencies_validation :
     [`This_block_belongs_to_a_detached_subtree|`This_block_was_loaded_from_persistence]
  -> ('a, 'b, 'c, 'd, [`Frontier_dependencies] * unit Truth.false_t, 'e, 'f) with_block
  -> ('a, 'b, 'c, 'd, [`Frontier_dependencies] * unit Truth.true_t, 'e, 'f) with_block
...
val validate_staged_ledger_diff :
  ...
  -> ('a, 'b, 'c, 'd, 'e, [`Staged_ledger_diff] * unit Truth.false_t, 'f) with_block

  -> ( ( [ `Just_emitted_a_proof of bool ]
       * [ `Block_with_validation of
           ('a, 'b, 'c, 'd, 'e, [`Staged_ledger_diff] * unit Truth.true_t, 'f) with_block ]
    ...
    , [> `Staged_ledger_application_failed of Staged_ledger.Staged_ledger_error.t
      |  `Invalid_staged_ledger_diff of 
           [ `Incorrect_target_staged_ledger_hash | `Incorrect_target_snarked_ledger_hash ] list ] )
    Deferred.Result.t

val validate_staged_ledger_hash :
     [`Staged_ledger_already_materialized of Staged_ledger_hash.t]
  -> ('a, 'b, 'c, 'd, 'e, [`Staged_ledger_diff] * unit Truth.false_t, 'f) with_block
  -> (('a, 'b, 'c, 'd, 'e, [`Staged_ledger_diff] * unit Truth.true_t, 'f) with_block, [> `Staged_ledger_hash_mismatch]) result
...
val validate_protocol_versions :
     ('a, 'b, 'c, 'd, 'e, 'f, [`Protocol_versions] * unit Truth.false_t) with_block
  -> (('a, 'b, 'c, 'd, 'e, 'f, [`Protocol_versions] * unit Truth.true_t) with_block, [> `Invalid_protocol_version | `Mismatched_protocol_version]) result

val skip_protocol_versions_validation :
     [`This_block_has_valid_protocol_versions]
  -> ('a, 'b, 'c, 'd, 'e, 'f, [`Protocol_versions] * unit Truth.false_t) with_block
  -> ('a, 'b, 'c, 'd, 'e, 'f, [`Protocol_versions] * unit Truth.true_t) with_block
