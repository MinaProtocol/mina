...
module Make (Impl : Curve_choice_S) = struct
  module State = struct
    include Array
  ...
  module Var = Tick0.Var
  module Sponge_params = Sponge_params.Functor.Make (Field)
  module Input = Input
  ...
  module T = Sponge.Make (Sponge.Poseidon (Inputs))
  include T
