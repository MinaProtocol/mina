...
module Statement = struct
  ...
  let compact_json_one (t : Transaction_snark.Statement.t) : Yojson.Safe.t =
    `Int (Transaction_snark.Statement.hash t)

  let compact_json t =
    `List (One_or_two.map ~f:compact_json_one t |> One_or_two.to_list)
