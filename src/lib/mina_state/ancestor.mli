module Input : sig
  module Stable : sig
    module V1 : sig
      type t =
        { descendant : Mina_base.State_hash.Stable.V1.t; generations : int }
  ...
  type t = Stable.V1.t =
    { descendant : Mina_base.State_hash.t; generations : int }
...
module Output = Mina_base.State_hash

module Proof : sig
  module Stable : sig
    module V1 : sig
      type t = Mina_base.State_body_hash.Stable.V1.t list
...
val verify : Input.t -> Mina_base.State_hash.t -> Proof.t -> bool
...
module Prover : sig
  ...
  val add :
       t
    -> prev_hash:Mina_base.State_hash.t
  ...
  val prove : t -> Input.t -> (Mina_base.State_hash.t * Proof.t) option
end
