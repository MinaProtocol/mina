      ...
      module Inputs = struct
        ...
        module Account = struct
          ...
          module Permissions = struct
            ...
            type version = Protocol_version.Checked.t
            ...
            let set_verification_key_version : t -> version =
      ...
      module Single (I : Single_inputs) = struct
        ...
        module Inputs = struct
          ...
          module Version = struct
            type t = Protocol_version.Checked.t

            let if_ cond ~then_ ~else_ =
              run_checked (Protocol_version.Checked.if_ cond ~then_ ~else_)

            let equal_to_current t =
              run_checked (Protocol_version.Checked.equal_to_current t)

            let older_than_current t =
              run_checked (Protocol_version.Checked.older_than_current t)
          end
