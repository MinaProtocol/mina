  ...
  module Ledger : sig
    ...
    module Addr : sig
      ...
      module Table : sig
        ...
        type ('a, 'b) hashtbl = ('a, 'b) Hash.Table.hashtbl
    ...
    module Location : sig
      ...
      module Map : sig
        ...
        module Tree : sig
          ...
          val of_hashtbl_exn : (Key.t, 'a) Hash.Table.hashtbl -> 'a t
      ...
      module Set : sig
        ...
        module Tree : sig
          ...
          val of_hashtbl_keys : (Elt.t, 'a) Hash.Table.hashtbl -> t
...
module Make : functor
       ...
       module Addr : sig
         ...
         module Table : sig
           ...
           type 'a merge_into_action =
                 'a Location.Addr.Table.merge_into_action =
             | Remove
             | Set_to of 'a
       ...
       module Location : sig
         module Addr : sig
           ...
           module Range : sig
             ...
             val subtree_range_seq :
                  ledger_depth:index
               -> Table.key
               -> Table.key Core_kernel.Sequence.t
           end
         ...
         module Set : sig
           ...
           module Tree : sig
             ...
             val of_hashtbl_keys : (Elt.t, 'a) Key.Table.hashtbl -> t
  ...
  val visualize : Inputs.Ledger.t -> initial_address:Inputs.Ledger.Addr.t -> t
