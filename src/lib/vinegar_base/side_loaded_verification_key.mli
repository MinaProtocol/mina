...
module Poly : sig
  module Stable : sig
    module V2 : sig
      type ('g, 'proofs_verified, 'vk) t =
        ...
        ; wrap_index : 'g Vinegar_types.Plonk_verification_key_evals.Stable.V2.t
        ; wrap_vk : 'vk option
        }
      [@@deriving hash]

      include
        Vinegar_types.Sigs.Binable.S3 with type ('a, 'b, 'c) t := ('a, 'b, 'c) t
  ...
  type ('g, 'proofs_verified, 'vk) t =
    ...
    { max_proofs_verified : 'proofs_verified
    ; actual_wrap_domain_size : 'proofs_verified
    ; wrap_index : 'g Vinegar_types.Plonk_verification_key_evals.t
    ; wrap_vk : 'vk option
    }
  [@@deriving hash]
end
...
val wrap_index_to_input :
     ('gs -> 'f array)
  -> 'gs Vinegar_types.Plonk_verification_key_evals.t
  -> 'f Random_oracle_input.Chunked.t

val index_to_field_elements :
     'a Vinegar_types.Plonk_verification_key_evals.t
  -> g:('a -> 'b Core_kernel.Array.t)
  -> 'b Core_kernel.Array.t

val to_input :
     field_of_int:(int -> 'a)
  -> ('a * 'a, Vinegar_base__Proofs_verified.t, 'b) Poly.t
...
module Repr : sig
  module Stable : sig
    module V2 : sig
      ...
      include Vinegar_types.Sigs.Binable.S1 with type 'a t := 'a t
...
module Width : sig
  ...
  module Length : Vinegar_types.Nat.Add.Intf_transparent
end
...
(** [Max_branches] is mostly an alias for {!Vinegar_types.Nat.N8} *)
module Max_branches : sig
  type 'a plus_n = 'a Vinegar_types.Nat.N7.plus_n Vinegar_types.Nat.s

  type n = Vinegar_types.Nat.z plus_n

  val eq : (n, n) Base.Type_equal.t

  val n : Vinegar_types.Nat.z plus_n Vinegar_types.Nat.nat

  val add :
       'm Vinegar_types.Nat.nat
    -> 'm plus_n Vinegar_types.Nat.nat
       * (Vinegar_types.Nat.z plus_n, 'm, 'm plus_n) Vinegar_types.Nat.Adds.t

  module Log2 = Vinegar_types.Nat.N3
end
