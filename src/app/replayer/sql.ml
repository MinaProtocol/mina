...
module User_command = struct
  ...
  let query =
    Mina_caqti.collect_req Mina_caqti.array_int_typ typ
  ...
  let run (module Conn : Mina_caqti.CONNECTION) user_cmd_ids =
...
module Internal_command = struct
  ...
  *)
  let query =
    Mina_caqti.collect_req
      Caqti_type.(t2 int64 Mina_caqti.array_int_typ)
      typ
  ...
  let run (module Conn : Mina_caqti.CONNECTION) ~start_slot ~internal_cmd_ids =
