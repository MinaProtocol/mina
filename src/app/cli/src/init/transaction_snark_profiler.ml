...
let load_constants' ?cli_proof_level ~logger ~config_file () =
  Runtime_config.Constants_loader.load_constants ~logger ?cli_proof_level
    config_file
  ...
  Command.async ~summary:"transaction snark profiler"
     ...
     *)
       ...
       let genesis_constants =
         Runtime_config.Constants_loader.t.genesis_constants
       in
       let constraint_constants =
         Runtime_config.Constants_loader.t.constraint_constants
       in
