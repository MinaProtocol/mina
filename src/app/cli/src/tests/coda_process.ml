...
let local_config ?(accounts = Account_config.sample_list) ?proposal_interval:_
    ~peers ~addrs_and_ports ~acceptable_delay ~program_dir ~proposer
    ~snark_worker_key ~work_selection_method ~offset ~trace_dir
