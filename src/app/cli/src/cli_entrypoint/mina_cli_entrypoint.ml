        ...
        fun () ->
          ...
          | `Ok sexp -> (
              let%bind worker_state =
                Snark_worker__Prod.Inputs.Worker_state.create
                  ~proof_level:Genesis_constants.Proof_level.compiled
                  ~constraint_constants:
                    Genesis_constants.Constraint_constants.compiled ()
              in
              ...
              in
              let spec = Snark_worker__Prod.Inputs.single_spec_of_sexp sexp in
              match%map
                Snark_worker__Prod.Inputs.perform_single worker_state
