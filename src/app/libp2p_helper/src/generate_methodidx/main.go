...
func main() {
	...
	an := analysis{
		...
		PackageName: "main",
		TypesAndValues: map[string][]string{
			"methodIdx": []string{"configure", "listen", "publish", "subscribe", "unsubscribe", "validationComplete", "generateKeypair", "openStream", "closeStream", "resetStream", "sendStreamMsg", "removeStreamHandler", "addStreamHandler", "listeningAddrs", "addPeer", "beginAdvertising", "findPeer", "listPeers", "setGatingConfig", "setNodeStatus", "getPeerNodeStatus", "getBandwidthInfo"},
		},
	}
