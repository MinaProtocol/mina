...
func TestExpectedPreForkFillUpperBound(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "default 2 whales 11.55M each, 50M dormant",
			numWhales:      2,
			activeStake:    11550000.0,
			dormantBalance: 50000000.0,
			// expected fill = 1 - (1 - 11.55/73.1)^2 = 0.291, + 0.10 = 0.391
			expectedUpper: 0.391,
		},
		{
			name:           "1 whale 11.55M, 50M dormant",
			numWhales:      1,
			activeStake:    11550000.0,
			dormantBalance: 50000000.0,
			// expected fill = 11.55/61.55 = 0.188, + 0.10 = 0.288
			expectedUpper: 0.288,
		},
		{
			...
			activeStake:    11550000.0,
			dormantBalance: 0,
			// expected fill = 1 - (1 - 11.55/23.1)^2 = 0.75, + 0.10 = 0.85
			expectedUpper: 0.85,
		},
		{
