...
While most protocols have just one primary node operator class (often called miners, validators, or block producers), Coda has a second class — the **snark worker**.
