...
2. Install the correct Postgres database package for your operating system. [here](https://www.postgresql.org/download/).
    - For MacOS users, you can install it with ```brew install postgresql```
...
1. First, you'll need to create a new database in Postgres.
...
(insert query for finding a specific transaction)
