...
<Alert kind="welcome">
  ...
  The Phase 3 testnet is launched! We send further announcements out on the [Coda Discord server](https://bit.ly/CodaDiscord) in the #announcements channel, as well as through email, when the network is live.
