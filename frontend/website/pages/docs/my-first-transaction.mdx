...
Sometimes Tiny goes to sleep or isn't feeling well. In that case, ask a fellow community member in the `#testnet-general` on Discord to send you some tokens!
