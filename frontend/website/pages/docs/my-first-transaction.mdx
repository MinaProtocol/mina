...
Once you set up the sandbox node, you can skip steps that pertain to running `coda daemon`.
...
For testing purposes, there's already an echo service set up that will immediately refund your payment minus the transaction fees. You can use the following public keys for the echo bot.
