...
Because only 200 participants can join testnet 3.2, you'll first need to get the peer addresses of the seed nodes. The 200 participants have already been selected, but you can sign up for the waitlist [here](https://docs.google.com/forms/d/e/1FAIpQLSfjfd8Tr9iy1gObKrfiI8upauksFpe5Tf_0ApZHri9jj4YIEA/viewform) in case a spot opens up. 

Once you're in, you'll receive an email close to release 3.2 launch date with the seed node addresses and updated commands. We can start by storing the seed addresses as environment variables to help with the next steps:
...
- The `sender` is the full public key, eg. `4vsRCVQq9Ai12E3acB1rymUK8PBifcpscd9u6DsmMWMAZWz2ABH4DXTQoCmGuvG6Q72v...`
