...
You may already have a public and private keypair generated before you download the new version of Coda. If this is the case, you can import it with the following command.

    coda accounts import keys/my-previously-generated-key
