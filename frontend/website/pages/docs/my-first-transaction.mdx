...
Because only 400 participants can join testnet 3.3, you'll first need to get the peer addresses of the seed nodes. The 400 participants have already been selected, but you can sign up for the waitlist [here](http://bit.ly/StakingSignup) in case a spot opens up. 
