...
Welcome to [Coda Genesis Program](https://codaprotocol.com/genesis) applicants!
...
As always we will continue to post updates in the #announcements channel in [Discord](https://bit.ly/CodaDiscord). If you're  interested in knowing when the Testnet is ready to connect to, feel free to set an alarm for Februrary 14th for an official update.
