...
If you'd like to send your coinbase to an account other than the one that is staking, you can use the `-block-producer-pubkey` flag when you start your daemon.
