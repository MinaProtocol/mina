...
<Alert kind="welcome">
  ...
  Welcome to [Coda Genesis Program](https://codaprotocol.com/genesis) applicants! You're in the right place to complete your application by connecting to Coda's testnet.
<<<<<<< HEAD
  The current status of the testnet is **OFFLINE** - The Phase 3 testnet will launch on Friday January 24, 2PM UTC-8. We will send an announcement out on the [Coda Discord server](https://bit.ly/CodaDiscord) in the #announcements channel, as well as through email, when the network is live.

  **Sign Up to Receive Stake** - [sign up here](http://bit.ly/StakingSignup) to receive a delegation to stake on the network. Block producers (nodes that stake coda and participate in consensus) are integral to the Coda network, and producing blocks will help you win testnet challenges and accumulate testnet points*. Reach out in the Discord server if you have any questions about signing up to stake on the testnet.
=======
  The current status of the is OFFLINE -- The Phase 3 testnet will launch on Friday January 24, 2PM UTC-8. We will send an announcement out on the [Coda Discord server](https://bit.ly/CodaDiscord) in the #announcements channel when the network is live.

  In the meanwhile, [sign up here](http://bit.ly/StakingSignup) to receieve a delegation to stake on the network. Block producers (nodes that stake coda and participate in consensus) are integral to the Coda network, and Genesis applicants that participate as block producers will be well positioned to become a founding member. 
  Reach out in the Discord server if you have any questions about signing up to stake on the testnet.
>>>>>>> develop
