...
/*     /1* <RunScript> *1/ */
/*     /1*   {Printf.sprintf( *1/ */
/*     /1*      {|document.getElementById("%s").checked = false;|}, *1/ */
/*     /1*      checkboxName, *1/ */
/*     /1*    )} *1/ */
/*     /1* </RunScript> *1/ */
/*   }; */
...
/*         </div> */
/*       </div> */
/*       /1* <div id="termynal" className=Styles.termynal> *1/ */
/*       /1*   <RunScript> *1/ */
/*       /1*     {|var termynal = new Termynal('#termynal', { *1/ */
         /*              /1*       typeDelay: 40, *1/ */
         /*              /1*       lineDelay: 700, *1/ */
         /*              /1*       lineData: [ *1/ */
         /*              /1*         { type: 'input', prompt: '>', value: 'coda daemon -peer ...' }, *1/ */
         /*              /1*         { type: 'progress' }, *1/ */
         /*              /1*         { value:  'Daemon ready. Clients can now connect!'}, *1/ */
         /*              /1*         { type: 'input', prompt: '>', value: 'coda client status' }, *1/ */
         /*              /1*         { delay: '0', value:  'Max observed block length: 120'}, *1/ */
         /*              /1*         { delay: '0', value:  'Peers: 23'}, *1/ */
         /*              /1*         { delay: '0', value:  'Consensus time now: epoch=1, slot=13'}, *1/ */
         /*              /1*         { delay: '0', value:  'Sync status: Synced'}, *1/ */
         /*              /1*       ] *1/ */
         /*              /1*     });|} *1/ */
/*       /1*   </RunScript> *1/ */
/*       /1* </div> *1/ */
