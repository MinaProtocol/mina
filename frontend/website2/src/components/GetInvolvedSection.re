...
module SocialLink = {
  ...
  module Svg = {
    let twitter = (~dims=(34, 28), colorVar) =>
      <svg
        width={Js.Int.toString(fst(dims)) ++ "px"}
        height={Js.Int.toString(snd(dims)) ++ "px"}
        viewBox="0 0 34 28"
        version="1.1"
              ...
              <g id="Discord" transform="translate(345.000000, 258.000000)">
                <g id="IconDiscord">
                  <path
                    ...
                    id="Eyes"
                    fill=Theme.Colors.(string(greyBlue))
                    style={fillStyle("--svg-color-social")}
                  />
                  <g id="Bubble">
    ...
    <a
      ...
      className=Css.(
        style([
          ...
          // unsafe("--svg-color-social", Theme.Colors.(string(greyBlue))),
          // hover([
          //   color(Theme.Colors.hyperlink),
          //   unsafe("--svg-color-social", Theme.Colors.(string(hyperlink))),
          // ]),
        ])
      )>
