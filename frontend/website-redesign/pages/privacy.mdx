...
This privacy policy ("**Policy**") describes how O(1) Labs Operating Corporation and its related companies ("**Company**") collect, use and share personal information of consumer users of this website, minaprotocol.com (the "**Site**"). This Policy also applies to any of our other websites that post this Policy. This Policy does not apply to websites that post different statements.
