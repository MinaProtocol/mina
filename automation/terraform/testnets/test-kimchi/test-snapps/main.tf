terraform {
  ...
  backend "s3" {
    key     = "terraform-test-kimchi.tfstate"
    encrypt = true
    region  = "us-west-2"
...
locals {
  testnet_name = "test-kimchi"
  mina_image = "gcr.io/o1labs-192920/mina-daemon-baked:1.2.0beta5-kimchi-circuits-7d5c0f1-buster-devnet-test-kimchi-3d16db5"
  mina_archive_image = "gcr.io/o1labs-192920/mina-archive:1.2.0beta5-kimchi-circuits-7d5c0f1-buster-devnet"
...
module "test-kimchi" {
  ...
  mina_archive_schema = "https://raw.githubusercontent.com/MinaProtocol/mina/kimchi-circuits/src/app/archive/create_schema.sql" 
  ...
  seed_peers_url                  = "https://storage.googleapis.com/seed-lists/test-kimchi.txt"
}
