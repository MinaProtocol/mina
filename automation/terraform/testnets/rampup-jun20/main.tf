terraform {
  ...
  backend "s3" {
    key     = "terraform-rampup-jun20.tfstate"
    encrypt = true
    region  = "us-west-2"
...
locals {
  testnet_name       = "rampup-jun20"
  mina_image         = "gcr.io/o1labs-192920/mina-daemon:2.0.0rampup2-rampup-testnet-jun20-fc665ac-bullseye-berkeley" #"minaprotocol/mina-daemon:1.3.2beta2-release-2.0.0-6f9d956-focal-berkeley"
  mina_archive_image = "gcr.io/o1labs-192920/mina-archive:2.0.0rampup2-rampup-testnet-jun20-fc665ac-bullseye"         #"minaprotocol/mina-archive:1.3.2beta2-release-2.0.0-6f9d956-focal"
...
module "rampup-jun20" {
  ...
  mina_archive_schema_aux_files = ["https://raw.githubusercontent.com/MinaProtocol/mina/rampup-testnet-jun20/src/app/archive/create_schema.sql", "https://raw.githubusercontent.com/MinaProtocol/mina/rampup-testnet-jun20/src/app/archive/zkapp_tables.sql"]
  ...
  # seed_peers_url                  = "https://storage.googleapis.com/seed-lists/rampup_seeds.txt"
