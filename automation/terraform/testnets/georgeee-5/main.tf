...
locals {
  testnet_name = "test-georgeee-5"
  mina_image = "gcr.io/o1labs-192920/mina-daemon-baked:1.2.0beta5-develop-eccf264-stretch-devnet-test-develop-3d16db5"
  mina_archive_image = "gcr.io/o1labs-192920/mina-archive:1.2.0beta5-develop-eccf264-stretch-devnet"
...
module "test-georgeee-5" {
  ...
  mina_archive_schema = "https://raw.githubusercontent.com/MinaProtocol/mina/compatible/src/app/archive/create_schema.sql" 
  ...
  snark_coordinators = [
    {
      ...
      snark_worker_public_key = "B62qjSJ3yTL4MAb9yYzV6WybmyK7NB6iH51N6DwAvJjCVVASsWwMBM3"
  ...
  seed_peers_url                  = "https://storage.googleapis.com/seed-lists/test-develop.txt"
}
