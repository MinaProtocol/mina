terraform {
  ...
  backend "s3" {
    key     = "terraform-mainnet-rc0-new.tfstate"
    encrypt = true
    region  = "us-west-2"
...
locals {
  testnet_name = "mainnet-rc0"
  coda_image = "gcr.io/o1labs-192920/coda-daemon-baked:1.0.0-fd39808-mainnet-rc0-fd39808"
...
module "mainnet-rc0" {
  ...
  seed_peers_url                  = "https://storage.googleapis.com/seed-lists/mainnet-rc0_seeds.txt"
}
