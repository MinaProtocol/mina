...
# this terraform file is configured to be run within CI
# env vars must be set on the CI agent for them to be inherited here
...
terraform {
    ...
    backend "s3" {
        key     = "terraform-template.tfstate" # !!!!! VALUE MUST BE UNIQUE !!!!!
        encrypt = true
        region  = "us-west-2"
...
locals {
    ...
    mina_image         = "minaprotocol/mina-daemon:focal-berkeley-latest"
    mina_archive_image = "minaprotocol/mina-archive:focal-latest"
...
module "berkeley" {
    ...
    mina_archive_schema_aux_files = [
        "https://raw.githubusercontent.com/MinaProtocol/mina/8468f29424fa5e70cfedf69ee281f4fa24037dfe/src/app/archive/create_schema.sql", 
        "https://raw.githubusercontent.com/MinaProtocol/mina/8468f29424fa5e70cfedf69ee281f4fa24037dfe/src/app/archive/zkapp_tables.sql"
        ]
